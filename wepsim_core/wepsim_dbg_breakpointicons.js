...
export function wepsim_register_breakpoint_icons()
{
    ws_info.breakpoint_icon_list = {
        ...
        'mate1':             { type: 'cars', addclass: 'no-dark-mode', origin: 'https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExd2FzdjZlMGI4Z2Qwb2V6c2RlajV2eng4N2E0dmw5Z3pnM3AybWw2cyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/tSUlOkeoYH5Pep0SAD/giphy.gif' },
        'mate2':             { type: 'cars', addclass: 'no-dark-mode', origin: 'https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExem5yMDduZnd0dm8za2NobXliNWNqb21rOTZveXNqZTlqODBpazM0MyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/Fj0bSHCzyhYL0kTzWP/giphy.gif' },
        'lightningmcqueen1': { type: 'cars', addclass: 'no-dark-mode', origin: 'https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExdmxmb3gyNjJ3ZjE1aDI1dmExZjFobW1mZ25hZHR2OWVxZnB1eTR4MCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9cw/lOo1pIV7kKrWwecbs6/giphy.gif' },
        'lightningmcqueen2': { type: 'cars', addclass: 'no-dark-mode', origin: 'https://tenor.com/es/view/ka-chow-lightning-mcqueen-cars-oh-yeah-cars-on-the-road-gif-26641273.gif' },
    } ;
}
