...
*/
    ...
    ws_info.config_ui.push({
                      ...
                      code_cfg:    wepsim_config_button_html_onoff('14g', 'History',
                                                     i18n_get_TagFor('cfg', 'Off'),
                                                     "ws.wepsim_config_button_toggle('history_enable', false, '14g'); ws.wepsim_config_button_toggle2('beta_history', false, '14');",
                                                     i18n_get_TagFor('cfg', 'On'),
                                                     "ws.wepsim_config_button_toggle('history_enable',  true, '14g'); ws.wepsim_config_button_toggle2('beta_history',  true, '14');"),
                      code_init:   function() {
