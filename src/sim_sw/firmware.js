 ...
 */
     ...
     import { firm_metadata_write,
              firm_metadata_read }            from "./firmware/firm_metadata.js";
     import { firm_instruction_write,
              firm_instruction_read }         from "./firmware/firm_instruction.js";
     import { firm_registers_write,
              firm_registers_read }           from "./firmware/firm_registers.js";
     import { firm_pseudoinstructions_write,
              firm_pseudoinstructions_read }  from "./firmware/firm_pseudoinstructions.js";
     import { simhw_sim_ctrlStates_get,
              simhw_internalState }           from "../sim_hw/sim_hw_index.js";
     import { frm_nextToken,
              frm_isToken,
              frm_langError }                 from "./firmware/lexical.js";
     ...
     import { simcore_native_get_signal,
              simcore_native_set_signal,
              simcore_native_get_value,
              simcore_native_set_value,
              simcore_native_get_fields,
              simcore_native_get_field_from_ir,
...
export function loadFirmware (text)
{
	   ...
	   if (mk_native != "")
           {
	       // eval(mk_native) ;
               let eval_executor = new Function('simcore_native_get_signal',
                                                'simcore_native_set_signal',
                                                'simcore_native_get_value',
                                                'simcore_native_set_value',
                                                'simcore_native_get_fields',
                                                ...
                                                'context',
                                                mk_native);
                   eval_executor(simcore_native_get_signal,
                                 simcore_native_set_signal,
                                 simcore_native_get_value,
                                 simcore_native_set_value,
                                 simcore_native_get_fields,
