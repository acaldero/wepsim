...
i18n.eltos.hw.de = {
    ...
    "EP:SOUND:STATES:ADDR": "Adressbus",
    "EP:SOUND:STATES:DATA": "Datenbus",
    "EP:SOUND:SIGNALS:IOR": "Von der Soundkarte lesen.",
    "EP:SOUND:SIGNALS:IOW": "Auf die Soundkarte schreiben.",
    "EP2:CPU_T1:STATES:IN": "Eingang ist der Wert des MBR-Registers",
    "EP2:CPU_T1:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T1:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T2:STATES:IN": "Eingang ist der Wert des PC-Registers",
    "EP2:CPU_T2:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T2:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T3:STATES:IN": "Eingang ist der Ausgang des Selektor-IR",
    "EP2:CPU_T3:STATES:OUT": "Ausgang geht an den internen Bus",
    "EP2:CPU_T3:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T4:STATES:IN": "Eingang ist der Wert des RT1-Registers",
    "EP2:CPU_T4:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T4:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T5:STATES:IN": "Eingang ist der Wert des RT2-Registers",
    "EP2:CPU_T5:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T5:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T6:STATES:IN": "Eingang ist der ALU-Ausgang",
    "EP2:CPU_T6:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T6:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T7:STATES:IN": "Eingang ist der Wert des RT3-Registers",
    "EP2:CPU_T7:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T7:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T8:STATES:IN": "Eingang ist der Wert des SR-Registers",
    "EP2:CPU_T8:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T8:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T9:STATES:IN": "Eingabe ist der Wert der Ausgabe von Register File Port A",
    "EP2:CPU_T9:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T9:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T10:STATES:IN": "Eingabe ist der Wert der Ausgabe von Register File Port B",
    "EP2:CPU_T10:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T10:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T11:STATES:IN": "Eingang ist der Mikrobefehl/ExCode-Ausgang",
    "EP2:CPU_T11:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T11:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_T12:STATES:IN": "Eingabe ist die HPC-Ausgabe (Hardware-Leistungszähler)",
    "EP2:CPU_T12:STATES:OUT": "Ausgang geht zum internen Bus",
    "EP2:CPU_T12:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_TA:STATES:IN": "Eingang ist der MAR-Registerausgang",
    "EP2:CPU_TA:STATES:OUT": "Ausgabe geht an den Adressbus",
    "EP2:CPU_TA:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_TB:STATES:IN": "Eingang ist der Byte-Selektor-Ausgang",
    "EP2:CPU_TB:STATES:OUT": "Ausgabe geht auf den Datenbus",
    "EP2:CPU_TB:SIGNALS:CTL": "Bestätigen, dass der Eingangswert in den Ausgang kopiert wird",
    "EP2:CPU_MUX_A:STATES:MUX_0": "Eingang 0 von MUX A, aus Registerdatei (A)",
    "EP2:CPU_MUX_A:STATES:MUX_1": "Eingang 1 von MUX A, aus RT1-Register",
    "EP2:CPU_MUX_A:STATES:MUX_O": "Ausgabe an ALU, Operator 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CPU_MUX_B:STATES:MUX_0": "Eingang 0 von MUX B, aus Registerdatei (B)",
    "EP2:CPU_MUX_B:STATES:MUX_1": "Eingang 1 von MUX B, aus RT2-Register",
    "EP2:CPU_MUX_B:STATES:MUX_2": "Eingang 2 von MUX B, Wert 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "Eingang 3 von MUX B, Wert 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "Ausgabe an ALU, Operator 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CPU_MUX_1:STATES:MUX_0": "Eingang 0 von MUX 1, vom internen Bus",
    "EP2:CPU_MUX_1:STATES:MUX_1": "Eingang 1 von MUX 1, vom Byte-Selektor",
    "EP2:CPU_MUX_1:STATES:MUX_O": "Ausgabe an MBR, von MUX 1",
    "EP2:CPU_MUX_1:SIGNALS:M1": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CPU_MUX_2:STATES:MUX_0": "Eingang 0 von MUX 2, vom internen Bus",
    "EP2:CPU_MUX_2:STATES:MUX_1": "Eingang 1 von MUX 2, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "Ausgabe auf PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CPU_MUX_7:STATES:MUX_0": "Eingang 0 von MUX 7, vom internen Bus",
    "EP2:CPU_MUX_7:STATES:MUX_1": "Eingang 1 von MUX 7, vom Flag-Selektor",
    "EP2:CPU_MUX_7:STATES:MUX_O": "Ausgabe an Register SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CU_MUX_A:STATES:MUX_0": "Eingang 0 von MUX A, von microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "Eingang 1 von MUX A, von co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "Eingang 2 von MUX A, von microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "Eingang 3 von MUX A, von 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "Ausgabe an microADDR, von MUX A",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "Ausgang des Steuergerätes MUX B",
    "EP2:CU_MUX_B:STATES:MUX_0": "Eingang 0 von MUX B, von MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "Eingang 1 von MUX B, von NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "Ausgabe an MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CU_MUX_C:STATES:MUX_0": "Eingang 0 von MUX C, von 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "Eingang 1 von MUX C, von INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "Eingang 2 von MUX C, von IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "Eingang 3 von MUX C, von MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "Eingang 4 von MUX C, von SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "Eingang 5 von MUX C, von SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "Eingang 6 von MUX C, von SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "Eingang 7 von MUX C, von SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "Eingang 8 von MUX C, von SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "Eingang 9 von MUX C, von SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "Eingang 10 von MUX C, von InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "Ausgabe an MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "Ausgang des Steuergerätes MUX C",
    "EP2:CU_MUX_RA:STATES:MUX_0": "Eingang 0 von MUX MR, von IR[SelA+0...SelA+4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "Eingang 1 von MUX MR, von SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "Ausgabe an RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CU_MUX_RB:STATES:MUX_0": "Eingang 0 von MUX MR, von IR[SelB+0...SelB+4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "Eingang 1 von MUX MR, von SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "Ausgabe an RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CU_MUX_RC:STATES:MUX_0": "Eingang 0 von MUX MR, von IR[SelC+0...SelC+4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "Eingang 1 von MUX MR, von SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "Ausgabe an RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:CU_MUX_MC:STATES:MUX_0": "Eingang 0 von MUX MC, von IR3...IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "Eingang 1 von MUX MC, von SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "Ausgabe an COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "Wählen Sie den Eingangswert aus, der an den Ausgang gesendet werden soll",
    "EP2:CPU_MUX_H:STATES:MUX_0": "Eingang 0 von MUX H, des Hardware-Leistungszählers",
    "EP2:CPU_MUX_H:STATES:MUX_1": "Eingang 1 von MUX H, des Hardware-Leistungszählers",
    "EP2:CPU_MUX_H:STATES:MUX_2": "Eingang 2 von MUX H, des Hardware-Leistungszählers",
    "EP2:CPU_MUX_H:STATES:MUX_3": "Eingang 3 von MUX H, des Hardware-Leistungszählers",
    "EP2:CPU_MUX_H:STATES:MUX_O": "Ausgabe an T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "Wählen Sie den Eingangswert aus, der an den Ausgang gesendet werden soll",
    "EP2:MAR:STATES:IN": "Eingang ist der interne Bus",
    "EP2:MAR:STATES:OUT": "Ausgabe geht an den Ta-Tristate",
    "EP2:MAR:SIGNALS:C0": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:MBR:STATES:IN": "Eingang ist der M1-Ausgang",
    "EP2:MBR:STATES:OUT": "Ausgabe geht an den T1-Tristate",
    "EP2:MBR:SIGNALS:C1": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:PC:STATES:IN": "Eingang ist der M2-Ausgang",
    "EP2:PC:STATES:OUT": "Ausgabe geht an den T2-Tristate",
    "EP2:PC:SIGNALS:CTL": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:IR:STATES:IN": "Eingang ist der interne Bus",
    "EP2:IR:STATES:OUT": "Ausgabe geht an den IR-Selektor und die CU",
    "EP2:IR:SIGNALS:C3": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:RT1:STATES:IN": "Eingang ist der interne Bus",
    "EP2:RT1:STATES:OUT": "Ausgabe geht an den T4-Tristate",
    "EP2:RT1:SIGNALS:CTL": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:RT2:STATES:IN": "Eingang ist der interne Bus",
    "EP2:RT2:STATES:OUT": "Ausgabe geht an den T5-Tristate",
    "EP2:RT2:SIGNALS:CTL": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:RT3:STATES:IN": "Eingang ist der Ausgang der ALU",
    "EP2:RT3:STATES:OUT": "Ausgabe geht an den T7-Tristate",
    "EP2:RT3:SIGNALS:CTL": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:SR:STATES:IN": "Eingang ist der Ausgang des M7",
    "EP2:SR:STATES:OUT": "Ausgang geht zum T8-Eingang und zur CU",
    "EP2:SR:SIGNALS:CTL": "Bestätigen, dass die Eingabe gespeichert ist",
    "EP2:REGISTER_FILE:STATES:A": "Ausgabe von RF an T9 und MA/0",
    "EP2:REGISTER_FILE:STATES:B": "Ausgabe von RF an T10 und MB/0",
    "EP2:REGISTER_FILE:STATES:C": "Eingang zu HF vom internen Bus",
    "EP2:REGISTER_FILE:SIGNALS:RA": "Wählen Sie das Register, dessen Wert an A gesendet wird",
    "EP2:REGISTER_FILE:SIGNALS:RB": "Wählen Sie das Register, dessen Wert an B gesendet wird",
    "EP2:REGISTER_FILE:SIGNALS:RC": "Wählen Sie das Register, in dem der Wert von C gespeichert ist",
    "EP2:REGISTER_FILE:SIGNALS:LC": "Bestätigen, dass RC aktualisiert wird",
    "EP2:CPU_ALU:STATES:A": "Ausgabe vom Multiplexer MUX A",
    "EP2:CPU_ALU:STATES:B": "Ausgabe vom Multiplexer MUX B",
    "EP2:CPU_ALU:STATES:ALU": "Ergebnis geht an den Eingang von T6 und RT3",
    "EP2:CPU_ALU:STATES:FLAGS": "C,V,N,Z Flags aktualisiert",
    "EP2:CPU_ALU:SIGNALS:COP": "Operationscode (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "Eingang 1 von SELECT-SR, U-Flag",
    "EP2:SELECT_SR:STATES:MUX_2": "Eingang 2 von SELECT-SR, I-Flag",
    "EP2:SELECT_SR:STATES:MUX_3": "Eingang 3 von SELECT-SR, Flags C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "Ausgabe an MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "Wählen Sie den Eingangswert, der an den Ausgang gesendet werden soll",
    "EP2:SELECT_IR:STATES:MUX_I": "Eingabe von SELECT-IR von IR",
    "EP2:SELECT_IR:STATES:MUX_O": "Ausgabe zum internen Bus über T3",
    "EP2:SELECT_IR:SIGNALS:SE": "Sign-Erweiterung",
    "EP2:SELECT_IR:SIGNALS:SIZE": "Größe",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "Offset",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "Eingabe vom MBR-Register",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "Eingabe vom Datenbus",
    "EP2:BYTE_SELECTOR:STATES:BE": "Ausgabe an BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "Ausgabe an M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "Ausgabe an Td/Eingang",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "In den Hauptspeicher schreiben",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "Sign-Erweiterung",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "Anzahl der zu packenden Bytes",
    "EP2:MEMORY:STATES:ADDR": "Adressbus",
    "EP2:MEMORY:STATES:DATA": "Datenbus",
    "EP2:MEMORY:STATES:MRDY": "Speicher bereit",
    "EP2:MEMORY:SIGNALS:BE": "BW+A1A0",
    "EP2:MEMORY:SIGNALS:R": "Lesen",
    "EP2:MEMORY:SIGNALS:W": "Schreiben",
    "EP2:IO:STATES:ADDR": "Adressbus",
    "EP2:IO:STATES:DATA": "Datenbus",
    "EP2:IO:SIGNALS:IOR": "Vom IO-Device lesen",
    "EP2:IO:SIGNALS:IOW": "In das IO-Device schreiben",
    "EP2:KEYBOARD:STATES:ADDR": "Adressbus",
    "EP2:KEYBOARD:STATES:DATA": "Datenbus",
    "EP2:KEYBOARD:SIGNALS:IOR": "Von Tastatur lesen",
    "EP2:DISPLAY:STATES:ADDR": "Adressbus",
    "EP2:DISPLAY:STATES:DATA": "Datenbus",
    "EP2:DISPLAY:SIGNALS:IOR": "Vom Display lesen (deaktiviert)",
    "EP2:DISPLAY:SIGNALS:IOW": "In das Display schreiben",
    "EP2:L3D:STATES:ADDR": "Adressbus",
    "EP2:L3D:STATES:DATA": "Datenbus",
    "EP2:L3D:SIGNALS:IOR": "Aus L3D lesen",
    "EP2:L3D:SIGNALS:IOW": "In die L3D schreiben",
    "EP2:LEDM:STATES:ADDR": "Adressbus",
    "EP2:LEDM:STATES:DATA": "Datenbus",
    "EP2:LEDM:SIGNALS:IOR": "Aus LEDM lesen",
    "EP2:LEDM:SIGNALS:IOW": "In die LEDM schreiben",
    "EP2:SOUND:STATES:ADDR": "Adressbus",
    "EP2:SOUND:STATES:DATA": "Datenbus",
    "EP2:SOUND:SIGNALS:IOR": "Von der Soundkarte lesen.",
    "EP2:SOUND:SIGNALS:IOW": "Auf die Soundkarte schreiben.",
