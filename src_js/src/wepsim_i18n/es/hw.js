...
i18n.eltos.hw.es = {
    ...
    "EP:SOUND:STATES:ADDR": "Bus de direcciones",
    "EP:SOUND:STATES:DATA": "Bus de datos",
    "EP:SOUND:SIGNALS:IOR": "Leer desde tarjeta de sonido",
    "EP:SOUND:SIGNALS:IOW": "Escribir a la tarjeta de sonido",
    "EP2:CPU_T1:STATES:IN": "La entrada es el valor del registro MBR",
    "EP2:CPU_T1:STATES:OUT": "La salida va al bus interno de datos",
    "EP2:CPU_T1:SIGNALS:CTL": "Confirma que el valor de entrad se copia a la salida",
    "EP2:CPU_T2:STATES:IN": "La entrada es el valor del registro de PC",
    "EP2:CPU_T2:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T2:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T3:STATES:IN": "La entrada es la salida del selector-IR",
    "EP2:CPU_T3:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T3:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T4:STATES:IN": "La entrada es el valor del registro RT1",
    "EP2:CPU_T4:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T4:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T5:STATES:IN": "La entrada es el valor del registro RT2",
    "EP2:CPU_T5:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T5:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T6:STATES:IN": "La entrada es la salida ALU",
    "EP2:CPU_T6:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T6:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T7:STATES:IN": "La entrada es el valor del registro RT3",
    "EP2:CPU_T7:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T7:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T8:STATES:IN": "La entrada es el valor del registro SR",
    "EP2:CPU_T8:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T8:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T9:STATES:IN": "La entrada es el valor de la salida del puerto A del banco de registros",
    "EP2:CPU_T9:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T9:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T10:STATES:IN": "La entrada es el valor de la salida del puerto B del banco de registros",
    "EP2:CPU_T10:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T10:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T11:STATES:IN": "La entrada es la salida de la microinstrucción/ExCode",
    "EP2:CPU_T11:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T11:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_T12:STATES:IN": "La entrada es la salida de Hardware Performance Counter (HPC)",
    "EP2:CPU_T12:STATES:OUT": "La salida va al bus interno",
    "EP2:CPU_T12:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_TA:STATES:IN": "La entrada es la salida del registro MAR",
    "EP2:CPU_TA:STATES:OUT": "La salida va al bus de direcciones",
    "EP2:CPU_TA:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_TB:STATES:IN": "La entrada es la salida del selector de bytes",
    "EP2:CPU_TB:STATES:OUT": "La salida va al bus de datos",
    "EP2:CPU_TB:SIGNALS:CTL": "Confirmar que el valor de entrada se copia a la salida",
    "EP2:CPU_MUX_A:STATES:MUX_0": "Entrada 0 de MUX A, del banco de registros (A)",
    "EP2:CPU_MUX_A:STATES:MUX_1": "Entrada 1 de MUX A, del registro RT1",
    "EP2:CPU_MUX_A:STATES:MUX_O": "Salida a ALU, operador 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CPU_MUX_B:STATES:MUX_0": "Entrada 0 de MUX B, del banco de registros (B)",
    "EP2:CPU_MUX_B:STATES:MUX_1": "Entrada 1 de MUX B, del registro RT2",
    "EP2:CPU_MUX_B:STATES:MUX_2": "Entrada 2 de MUX B, valor 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "Entrada 3 de MUX B, valor 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "Salida a ALU, operador 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CPU_MUX_1:STATES:MUX_0": "Entrada 0 de MUX 1, desde bus interno",
    "EP2:CPU_MUX_1:STATES:MUX_1": "Entrada 1 de MUX 1, del selector de bytes",
    "EP2:CPU_MUX_1:STATES:MUX_O": "Salida a MBR, desde MUX 1",
    "EP2:CPU_MUX_1:SIGNALS:M1": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CPU_MUX_2:STATES:MUX_0": "Entrada 0 de MUX 2, desde bus interno",
    "EP2:CPU_MUX_2:STATES:MUX_1": "Entrada 1 de MUX 2, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "Salida a PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CPU_MUX_7:STATES:MUX_0": "Entrada 0 de MUX 7, desde bus interno",
    "EP2:CPU_MUX_7:STATES:MUX_1": "Entrada 1 de MUX 7, desde el selector de banderas",
    "EP2:CPU_MUX_7:STATES:MUX_O": "Salida para registrar SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CU_MUX_A:STATES:MUX_0": "Entrada 0 de MUX A, desde microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "Entrada 1 de MUX A, de co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "Entrada 2 de MUX A, desde microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "Entrada 3 de MUX A, desde 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "Salida a microADDR, desde MUX A",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "Salida de la unidad de control MUX B",
    "EP2:CU_MUX_B:STATES:MUX_0": "Entrada 0 de MUX B, desde MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "Entrada 1 de MUX B, de NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "Salida a MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CU_MUX_C:STATES:MUX_0": "Entrada 0 de MUX C, desde 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "Entrada 1 de MUX C, desde INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "Entrada 2 de MUX C, de IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "Entrada 3 de MUX C, de MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "Entrada 4 de MUX C, desde SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "Entrada 5 de MUX C, desde SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "Entrada 6 de MUX C, desde SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "Entrada 7 de MUX C, desde SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "Entrada 8 de MUX C, desde SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "Entrada 9 de MUX C, desde SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "Entrada 10 de MUX C, desde InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "Salida a MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "Salida de la unidad de control MUX C",
    "EP2:CU_MUX_RA:STATES:MUX_0": "Entrada 0 de MUX MR, desde IR [SelA + 0 ... SelA + 4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "Entrada 1 de MUX MR, de SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "Salida a RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CU_MUX_RB:STATES:MUX_0": "Entrada 0 de MUX MR, desde IR [SelB + 0 ... SelB + 4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "Entrada 1 de MUX MR, de SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "Salida a RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CU_MUX_RC:STATES:MUX_0": "Entrada 0 de MUX MR, desde IR [SelC + 0 ... SelC + 4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "Entrada 1 de MUX MR, de SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "Salida a RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CU_MUX_MC:STATES:MUX_0": "Entrada 0 de MUX MC, desde IR3 ... IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "Entrada 1 de MUX MC, de SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "Salida a COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:CPU_MUX_H:STATES:MUX_0": "Entrada 0 de MUX H, del Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_1": "Entrada 1 de MUX H, del Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_2": "Entrada 2 de MUX H, del Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_3": "Entrada 3 de MUX H, del Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_O": "Salida a T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:MAR:STATES:IN": "La entrada es el bus interno",
    "EP2:MAR:STATES:OUT": "La salida va al estado Ta",
    "EP2:MAR:SIGNALS:C0": "Confirmar que la entrada está almacenada",
    "EP2:MBR:STATES:IN": "La entrada es la salida M1",
    "EP2:MBR:STATES:OUT": "La salida va al triestado T1",
    "EP2:MBR:SIGNALS:C1": "Confirmar que la entrada está almacenada",
    "EP2:PC:STATES:IN": "La entrada es la salida M2",
    "EP2:PC:STATES:OUT": "La salida va al triestado T2",
    "EP2:PC:SIGNALS:CTL": "Confirmar que la entrada está almacenada",
    "EP2:IR:STATES:IN": "La entrada es el bus interno",
    "EP2:IR:STATES:OUT": "La salida va al selector IR y al CU",
    "EP2:IR:SIGNALS:C3": "Confirmar que la entrada está almacenada",
    "EP2:RT1:STATES:IN": "La entrada es el bus interno",
    "EP2:RT1:STATES:OUT": "La salida va al triestado T4",
    "EP2:RT1:SIGNALS:CTL": "Confirmar que la entrada está almacenada",
    "EP2:RT2:STATES:IN": "La entrada es el bus interno",
    "EP2:RT2:STATES:OUT": "La salida va al triestado T5",
    "EP2:RT2:SIGNALS:CTL": "Confirmar que la entrada está almacenada",
    "EP2:RT3:STATES:IN": "La entrada es la salida de la ALU",
    "EP2:RT3:STATES:OUT": "La salida va al triestado T7",
    "EP2:RT3:SIGNALS:CTL": "Confirmar que la entrada está almacenada",
    "EP2:SR:STATES:IN": "La entrada es la salida del M7",
    "EP2:SR:STATES:OUT": "La salida va a la entrada T8 y la CU",
    "EP2:SR:SIGNALS:CTL": "Confirmar que la entrada está almacenada",
    "EP2:REGISTER_FILE:STATES:A": "Salida de RF a T9 y MA/0",
    "EP2:REGISTER_FILE:STATES:B": "Salida de RF a T10 y MB/0",
    "EP2:REGISTER_FILE:STATES:C": "Entrada a RF desde bus interno",
    "EP2:REGISTER_FILE:SIGNALS:RA": "Seleccione el registro cuyo valor se envía a A",
    "EP2:REGISTER_FILE:SIGNALS:RB": "Seleccione el registro cuyo valor se envía a B",
    "EP2:REGISTER_FILE:SIGNALS:RC": "Seleccione el registro donde se almacena el valor de C",
    "EP2:REGISTER_FILE:SIGNALS:LC": "Confirme que RC se va a actualizar",
    "EP2:CPU_ALU:STATES:A": "Salida del multiplexor MUX A",
    "EP2:CPU_ALU:STATES:B": "Salida del multiplexor MUX B",
    "EP2:CPU_ALU:STATES:ALU": "El resultado va a la entrada de T6 y RT3",
    "EP2:CPU_ALU:STATES:FLAGS": "Banderas C, V, N, Z actualizadas",
    "EP2:CPU_ALU:SIGNALS:COP": "Código de operación (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "Entrada 1 de SELECT-SR, bandera U",
    "EP2:SELECT_SR:STATES:MUX_2": "Entrada 2 de SELECT-SR, indicador I",
    "EP2:SELECT_SR:STATES:MUX_3": "Entrada 3 de SELECT-SR, marca C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "Salida a MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "Seleccione el valor de entrada para enviar a la salida",
    "EP2:SELECT_IR:STATES:MUX_I": "Entrada de SELECT-IR desde IR",
    "EP2:SELECT_IR:STATES:MUX_O": "Salida a bus interno a través de T3",
    "EP2:SELECT_IR:SIGNALS:SE": "Extensión de señal",
    "EP2:SELECT_IR:SIGNALS:SIZE": "Tamaño",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "Offset",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "Entrada del registro MBR",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "Entrada desde bus de datos",
    "EP2:BYTE_SELECTOR:STATES:BE": "Salida a BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "Salida a M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "Salida a Td/entrada",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "Escribir en la memoria principal",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "Extensión de señal",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "Número de bytes para empaquetar",
    "EP2:MEMORY:STATES:ADDR": "Bus de direcciones",
    "EP2:MEMORY:STATES:DATA": "Bus de datos",
    "EP2:MEMORY:STATES:MRDY": "Memoria lista",
    "EP2:MEMORY:SIGNALS:BE": "BW + A1A0",
    "EP2:MEMORY:SIGNALS:R": "Leer",
    "EP2:MEMORY:SIGNALS:W": "Escribir",
    "EP2:IO:STATES:ADDR": "Bus de direcciones",
    "EP2:IO:STATES:DATA": "Bus de datos",
    "EP2:IO:SIGNALS:IOR": "Leer desde dispositivo IO",
    "EP2:IO:SIGNALS:IOW": "Escribir en el dispositivo IO",
    "EP2:KEYBOARD:STATES:ADDR": "Bus de direcciones",
    "EP2:KEYBOARD:STATES:DATA": "Bus de datos",
    "EP2:KEYBOARD:SIGNALS:IOR": "Leer desde el teclado",
    "EP2:DISPLAY:STATES:ADDR": "Bus de direcciones",
    "EP2:DISPLAY:STATES:DATA": "Bus de datos",
    "EP2:DISPLAY:SIGNALS:IOR": "Leer de la pantalla (desactivado)",
    "EP2:DISPLAY:SIGNALS:IOW": "Escribir en la pantalla",
    "EP2:L3D:STATES:ADDR": "Bus de direcciones",
    "EP2:L3D:STATES:DATA": "Bus de datos",
    "EP2:L3D:SIGNALS:IOR": "Leer desde L3D",
    "EP2:L3D:SIGNALS:IOW": "Escribir en L3D",
    "EP2:LEDM:STATES:ADDR": "Bus de direcciones",
    "EP2:LEDM:STATES:DATA": "Bus de datos",
    "EP2:LEDM:SIGNALS:IOR": "Leer desde LEDM",
    "EP2:LEDM:SIGNALS:IOW": "Escribir en LEDM",
    "EP2:SOUND:STATES:ADDR": "Bus de direcciones",
    "EP2:SOUND:STATES:DATA": "Bus de datos",
    "EP2:SOUND:SIGNALS:IOR": "Leer desde tarjeta de sonido",
    "EP2:SOUND:SIGNALS:IOW": "Escribir a la tarjeta de sonido",
