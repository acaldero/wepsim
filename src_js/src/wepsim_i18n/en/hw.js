...
i18n.eltos.hw.en = {
    ...
    "EP:SOUND:STATES:ADDR": "Address bus",
    "EP:SOUND:STATES:DATA": "Data bus",
    "EP:SOUND:SIGNALS:IOR": "Read from sound card",
    "EP:SOUND:SIGNALS:IOW": "Write into the sound card",
    "EP2:CPU_T1:STATES:IN": "Input is the value of MBR register",
    "EP2:CPU_T1:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T1:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T2:STATES:IN": "Input is the value of PC register",
    "EP2:CPU_T2:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T2:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T3:STATES:IN": "Input is the output of the selector-IR",
    "EP2:CPU_T3:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T3:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T4:STATES:IN": "Input is the value of RT1 register",
    "EP2:CPU_T4:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T4:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T5:STATES:IN": "Input is the value of RT2 register",
    "EP2:CPU_T5:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T5:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T6:STATES:IN": "Input is the ALU output",
    "EP2:CPU_T6:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T6:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T7:STATES:IN": "Input is the value of RT3 register",
    "EP2:CPU_T7:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T7:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T8:STATES:IN": "Input is the value of SR register",
    "EP2:CPU_T8:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T8:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T9:STATES:IN": "Input is the value of the Register File port A output",
    "EP2:CPU_T9:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T9:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T10:STATES:IN": "Input is the value of the Register File port B output",
    "EP2:CPU_T10:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T10:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T11:STATES:IN": "Input is the microinstruction/ExCode output",
    "EP2:CPU_T11:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T11:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_T12:STATES:IN": "Input is the HPC (hardware performance counter) output",
    "EP2:CPU_T12:STATES:OUT": "Output goes to the Internal Bus",
    "EP2:CPU_T12:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_TA:STATES:IN": "Input is the MAR register output",
    "EP2:CPU_TA:STATES:OUT": "Output goes to the Address Bus",
    "EP2:CPU_TA:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_TB:STATES:IN": "Input is the Byte Selector output",
    "EP2:CPU_TB:STATES:OUT": "Output goes to the data bus",
    "EP2:CPU_TB:SIGNALS:CTL": "Confirm that input value is copied to the output",
    "EP2:CPU_MUX_A:STATES:MUX_0": "Input 0 of MUX A, from Register File (A)",
    "EP2:CPU_MUX_A:STATES:MUX_1": "Input 1 of MUX A, from RT1 register",
    "EP2:CPU_MUX_A:STATES:MUX_O": "Output to ALU, operator 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "Select the input value to send to the output",
    "EP2:CPU_MUX_B:STATES:MUX_0": "Input 0 of MUX B, from Register File (B)",
    "EP2:CPU_MUX_B:STATES:MUX_1": "Input 1 of MUX B, from RT2 register",
    "EP2:CPU_MUX_B:STATES:MUX_2": "Input 2 of MUX B, value 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "Input 3 of MUX B, value 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "Output to ALU, operator 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "Select the input value to send to the output",
    "EP2:CPU_MUX_1:STATES:MUX_0": "Input 0 of MUX 1, from Internal Bus",
    "EP2:CPU_MUX_1:STATES:MUX_1": "Input 1 of MUX 1, from Byte Selector",
    "EP2:CPU_MUX_1:STATES:MUX_O": "Output to MBR, from MUX 1",
    "EP2:CPU_MUX_1:SIGNALS:M1": "Select the input value to send to the output",
    "EP2:CPU_MUX_2:STATES:MUX_0": "Input 0 of MUX 2, from Internal Bus",
    "EP2:CPU_MUX_2:STATES:MUX_1": "Input 1 of MUX 2, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "Output to PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "Select the input value to send to the output",
    "EP2:CPU_MUX_7:STATES:MUX_0": "Input 0 of MUX 7, from Internal Bus",
    "EP2:CPU_MUX_7:STATES:MUX_1": "Input 1 of MUX 7, from Flag Selector",
    "EP2:CPU_MUX_7:STATES:MUX_O": "Output to register SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "Select the input value to send to the output",
    "EP2:CU_MUX_A:STATES:MUX_0": "Input 0 of MUX A, from microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "Input 1 of MUX A, from co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "Input 2 of MUX A, from microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "Input 3 of MUX A, from 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "Output to microADDR, from MUX A",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "Output of control unit MUX B",
    "EP2:CU_MUX_B:STATES:MUX_0": "Input 0 of MUX B, from MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "Input 1 of MUX B, from NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "Output to MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "Select the input value to send to the output",
    "EP2:CU_MUX_C:STATES:MUX_0": "Input  0 of MUX C, from 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "Input  1 of MUX C, from INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "Input  2 of MUX C, from IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "Input  3 of MUX C, from MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "Input  4 of MUX C, from SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "Input  5 of MUX C, from SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "Input  6 of MUX C, from SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "Input  7 of MUX C, from SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "Input  8 of MUX C, from SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "Input  9 of MUX C, from SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "Input 10 of MUX C, from InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "Output to MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "Output of control unit MUX C",
    "EP2:CU_MUX_RA:STATES:MUX_0": "Input 0 of MUX MR, from IR[SelA+0...SelA+4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "Input 1 of MUX MR, from SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "Output to RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "Select the input value to send to the output",
    "EP2:CU_MUX_RB:STATES:MUX_0": "Input 0 of MUX MR, from IR[SelB+0...SelB+4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "Input 1 of MUX MR, from SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "Output to RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "Select the input value to send to the output",
    "EP2:CU_MUX_RC:STATES:MUX_0": "Input 0 of MUX MR, from IR[SelC+0...SelC+4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "Input 1 of MUX MR, from SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "Output to RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "Select the input value to send to the output",
    "EP2:CU_MUX_MC:STATES:MUX_0": "Input 0 of MUX MC, from IR3...IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "Input 1 of MUX MC, from SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "Output to COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "Select the input value to send to the output",
    "EP2:CPU_MUX_H:STATES:MUX_0": "Input 0 of MUX H, of the Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_1": "Input 1 of MUX H, of the Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_2": "Input 2 of MUX H, of the Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_3": "Input 3 of MUX H, of the Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_O": "Output to T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "Select the input value to send to the output",
    "EP2:MAR:STATES:IN": "Input is the Internal Bus",
    "EP2:MAR:STATES:OUT": "Output goes to the Ta tristate",
    "EP2:MAR:SIGNALS:C0": "Confirm that input is stored",
    "EP2:MBR:STATES:IN": "Input is the M1 output",
    "EP2:MBR:STATES:OUT": "Output goes to the T1 tristate",
    "EP2:MBR:SIGNALS:C1": "Confirm that input is stored",
    "EP2:PC:STATES:IN": "Input is the M2 output",
    "EP2:PC:STATES:OUT": "Output goes to the T2 tristate",
    "EP2:PC:SIGNALS:CTL": "Confirm that input is stored",
    "EP2:IR:STATES:IN": "Input is the Internal Bus",
    "EP2:IR:STATES:OUT": "Output goes to the IR selector and the CU",
    "EP2:IR:SIGNALS:C3": "Confirm that input is stored",
    "EP2:RT1:STATES:IN": "Input is the Internal Bus",
    "EP2:RT1:STATES:OUT": "Output goes to the T4 tristate",
    "EP2:RT1:SIGNALS:CTL": "Confirm that input is stored",
    "EP2:RT2:STATES:IN": "Input is the Internal Bus",
    "EP2:RT2:STATES:OUT": "Output goes to the T5 tristate",
    "EP2:RT2:SIGNALS:CTL": "Confirm that input is stored",
    "EP2:RT3:STATES:IN": "Input is the output of the ALU",
    "EP2:RT3:STATES:OUT": "Output goes to the T7 tristate",
    "EP2:RT3:SIGNALS:CTL": "Confirm that input is stored",
    "EP2:SR:STATES:IN": "Input is the output of the M7",
    "EP2:SR:STATES:OUT": "Output goes to the T8 input and the CU",
    "EP2:SR:SIGNALS:CTL": "Confirm that input is stored",
    "EP2:REGISTER_FILE:STATES:A": "Output of RF to T9 and MA/0",
    "EP2:REGISTER_FILE:STATES:B": "Output of RF to T10 and MB/0",
    "EP2:REGISTER_FILE:STATES:C": "Input to RF from Internal Bus",
    "EP2:REGISTER_FILE:SIGNALS:RA": "Select the register which value is sent to A",
    "EP2:REGISTER_FILE:SIGNALS:RB": "Select the register which value is sent to B",
    "EP2:REGISTER_FILE:SIGNALS:RC": "Select the register where C's value is stored",
    "EP2:REGISTER_FILE:SIGNALS:LC": "Confirm that RC is going to be updated",
    "EP2:CPU_ALU:STATES:A": "Output from MUX A multiplexor",
    "EP2:CPU_ALU:STATES:B": "Output from MUX B multiplexor",
    "EP2:CPU_ALU:STATES:ALU": "Result goes to the input of T6 and RT3",
    "EP2:CPU_ALU:STATES:FLAGS": "Updated C,V,N,Z flags",
    "EP2:CPU_ALU:SIGNALS:COP": "Operation code (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "Input 1 of SELECT-SR, U flag",
    "EP2:SELECT_SR:STATES:MUX_2": "Input 2 of SELECT-SR, I flag",
    "EP2:SELECT_SR:STATES:MUX_3": "Input 3 of SELECT-SR, flags C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "Output to MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "Select the input value to send to the output",
    "EP2:SELECT_IR:STATES:MUX_I": "Input of SELECT-IR from IR",
    "EP2:SELECT_IR:STATES:MUX_O": "Output to Internal Bus through T3",
    "EP2:SELECT_IR:SIGNALS:SE": "Sign Extension",
    "EP2:SELECT_IR:SIGNALS:SIZE": "Size",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "Offset",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "Input from MBR register",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "Input from Data Bus",
    "EP2:BYTE_SELECTOR:STATES:BE": "Output to BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "Output to M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "Output to Td/input",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "Write into main memory",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "Sign Extension",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "Number of bytes to pack",
    "EP2:MEMORY:STATES:ADDR": "Address bus",
    "EP2:MEMORY:STATES:DATA": "Data bus",
    "EP2:MEMORY:STATES:MRDY": "Memory ready",
    "EP2:MEMORY:SIGNALS:BE": "BW+A1A0",
    "EP2:MEMORY:SIGNALS:R": "Read",
    "EP2:MEMORY:SIGNALS:W": "Write",
    "EP2:IO:STATES:ADDR": "Address bus",
    "EP2:IO:STATES:DATA": "Data bus",
    "EP2:IO:SIGNALS:IOR": "Read from IO device",
    "EP2:IO:SIGNALS:IOW": "Write into the IO device",
    "EP2:KEYBOARD:STATES:ADDR": "Address bus",
    "EP2:KEYBOARD:STATES:DATA": "Data bus",
    "EP2:KEYBOARD:SIGNALS:IOR": "Read from keyboard",
    "EP2:DISPLAY:STATES:ADDR": "Address bus",
    "EP2:DISPLAY:STATES:DATA": "Data bus",
    "EP2:DISPLAY:SIGNALS:IOR": "Read from display (disabled)",
    "EP2:DISPLAY:SIGNALS:IOW": "Write into the display",
    "EP2:L3D:STATES:ADDR": "Address bus",
    "EP2:L3D:STATES:DATA": "Data bus",
    "EP2:L3D:SIGNALS:IOR": "Read from L3D",
    "EP2:L3D:SIGNALS:IOW": "Write into the L3D",
    "EP2:LEDM:STATES:ADDR": "Address bus",
    "EP2:LEDM:STATES:DATA": "Data bus",
    "EP2:LEDM:SIGNALS:IOR": "Read from LEDM",
    "EP2:LEDM:SIGNALS:IOW": "Write into the LEDM",
    "EP2:SOUND:STATES:ADDR": "Address bus",
    "EP2:SOUND:STATES:DATA": "Data bus",
    "EP2:SOUND:SIGNALS:IOR": "Read from sound card",
    "EP2:SOUND:SIGNALS:IOW": "Write into the sound card",
