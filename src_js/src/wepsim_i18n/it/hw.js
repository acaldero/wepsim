...
i18n.eltos.hw.it = {
    ...
    "EP:SOUND:STATES:ADDR": "Bus indirizzi",
    "EP:SOUND:STATES:DATA": "Bus dati",
    "EP:SOUND:SIGNALS:IOR": "Leggi dalla scheda audio.",
    "EP:SOUND:SIGNALS:IOW": "Scrivi sulla scheda audio.",
    "EP2:CPU_T1:STATES:IN": "Input è il valore del registro MBR",
    "EP2:CPU_T1:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T1:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T2:STATES:IN": "L'ingresso è il valore del registro PC",
    "EP2:CPU_T2:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T2:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T3:STATES:IN": "L'ingresso è l'uscita del selettore-IR",
    "EP2:CPU_T3:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T3:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T4:STATES:IN": "L'ingresso è il valore del registro RT1",
    "EP2:CPU_T4:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T4:SIGNALS:CTL": "Conferma che il valore di ingresso sia copiato nell'uscita",
    "EP2:CPU_T5:STATES:IN": "L'ingresso è il valore del registro RT2",
    "EP2:CPU_T5:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T5:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T6:STATES:IN": "L'ingresso è l'uscita ALU",
    "EP2:CPU_T6:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T6:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T7:STATES:IN": "L'ingresso è il valore del registro RT3",
    "EP2:CPU_T7:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T7:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T8:STATES:IN": "Input è il valore del registro SR",
    "EP2:CPU_T8:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T8:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T9:STATES:IN": "Input è il valore dell'output della porta A del file di registro",
    "EP2:CPU_T9:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T9:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T10:STATES:IN": "Input è il valore dell'output della porta B del file di registro",
    "EP2:CPU_T10:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T10:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T11:STATES:IN": "L'ingresso è la microistruzione/uscita ExCode",
    "EP2:CPU_T11:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T11:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_T12:STATES:IN": "L'ingresso è l'uscita HPC (contatore delle prestazioni hardware)",
    "EP2:CPU_T12:STATES:OUT": "L'uscita va al bus interno",
    "EP2:CPU_T12:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_TA:STATES:IN": "L'ingresso è l'uscita del registro MAR",
    "EP2:CPU_TA:STATES:OUT": "L'uscita va al bus indirizzi",
    "EP2:CPU_TA:SIGNALS:CTL": "Conferma che il valore di ingresso sia copiato nell'uscita",
    "EP2:CPU_TB:STATES:IN": "L'ingresso è l'uscita del selettore di byte",
    "EP2:CPU_TB:STATES:OUT": "L'uscita va al bus dati",
    "EP2:CPU_TB:SIGNALS:CTL": "Conferma che il valore di ingresso viene copiato nell'uscita",
    "EP2:CPU_MUX_A:STATES:MUX_0": "Ingresso 0 del MUX A, da File Registro (A)",
    "EP2:CPU_MUX_A:STATES:MUX_1": "Ingresso 1 del MUX A, dal registro RT1",
    "EP2:CPU_MUX_A:STATES:MUX_O": "Uscita su ALU, operatore 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CPU_MUX_B:STATES:MUX_0": "Ingresso 0 del MUX B, da File Registro (B)",
    "EP2:CPU_MUX_B:STATES:MUX_1": "Ingresso 1 del MUX B, dal registro RT2",
    "EP2:CPU_MUX_B:STATES:MUX_2": "Ingresso 2 del MUX B, valore 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "Ingresso 3 del MUX B, valore 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "Uscita su ALU, operatore 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CPU_MUX_1:STATES:MUX_0": "Ingresso 0 del MUX 1, da Bus Interno",
    "EP2:CPU_MUX_1:STATES:MUX_1": "Ingresso 1 del MUX 1, da Byte Selector",
    "EP2:CPU_MUX_1:STATES:MUX_O": "Uscita su MBR, da MUX 1",
    "EP2:CPU_MUX_1:SIGNALS:M1": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CPU_MUX_2:STATES:MUX_0": "Ingresso 0 del MUX 2, da Bus Interno",
    "EP2:CPU_MUX_2:STATES:MUX_1": "Ingresso 1 di MUX 2, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "Uscita al PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CPU_MUX_7:STATES:MUX_0": "Ingresso 0 del MUX 7, da Bus Interno",
    "EP2:CPU_MUX_7:STATES:MUX_1": "Ingresso 1 del MUX 7, da Flag Selector",
    "EP2:CPU_MUX_7:STATES:MUX_O": "Uscita per registrare SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CU_MUX_A:STATES:MUX_0": "Ingresso 0 del MUX A, da microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "Ingresso 1 del MUX A, da co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "Ingresso 2 del MUX A, da microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "Ingresso 3 del MUX A, da 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "Uscita a microADDR, da MUX A",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "Uscita centralina MUX B",
    "EP2:CU_MUX_B:STATES:MUX_0": "Ingresso 0 del MUX B, dal MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "Ingresso 1 del MUX B, da NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "Uscita al MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CU_MUX_C:STATES:MUX_0": "Ingresso 0 del MUX C, da 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "Ingresso 1 del MUX C, da INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "Ingresso 2 del MUX C, da IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "Ingresso 3 del MUX C, da MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "Ingresso 4 del MUX C, da SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "Ingresso 5 del MUX C, da SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "Ingresso 6 del MUX C, da SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "Ingresso 7 del MUX C, da SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "Ingresso 8 del MUX C, da SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "Ingresso 9 del MUX C, da SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "Ingresso 10 del MUX C, da InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "Uscita al MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "Uscita della centralina MUX C",
    "EP2:CU_MUX_RA:STATES:MUX_0": "Ingresso 0 di MUX MR, da IR[SelA+0...SelA+4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "Ingresso 1 di MUX MR, da SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "Uscita su RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CU_MUX_RB:STATES:MUX_0": "Ingresso 0 di MUX MR, da IR[SelB+0...SelB+4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "Ingresso 1 di MUX MR, da SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "Uscita su RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CU_MUX_RC:STATES:MUX_0": "Ingresso 0 di MUX MR, da IR[SelC+0...SelC+4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "Ingresso 1 di MUX MR, da SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "Uscita su RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CU_MUX_MC:STATES:MUX_0": "Ingresso 0 del MUX MC, da IR3...IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "Ingresso 1 di MUX MC, da SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "Uscita su COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:CPU_MUX_H:STATES:MUX_0": "Input 0 di MUX H, dell'Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_1": "Input 1 di MUX H, dell'Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_2": "Input 2 di MUX H, dell'Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_3": "Input 3 di MUX H, dell'Hardware Performance Counter",
    "EP2:CPU_MUX_H:STATES:MUX_O": "Uscita su T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:MAR:STATES:IN": "L'ingresso è il bus interno",
    "EP2:MAR:STATES:OUT": "L'uscita va al tristato Ta",
    "EP2:MAR:SIGNALS:C0": "Conferma che l'ingresso è memorizzato",
    "EP2:MBR:STATES:IN": "L'ingresso è l'uscita M1",
    "EP2:MBR:STATES:OUT": "L'uscita va al tristato T1",
    "EP2:MBR:SIGNALS:C1": "Conferma che l'ingresso è memorizzato",
    "EP2:PC:STATES:IN": "L'ingresso è l'uscita M2",
    "EP2:PC:STATES:OUT": "L'uscita va al tristato T2",
    "EP2:PC:SIGNALS:CTL": "Conferma che l'ingresso è memorizzato",
    "EP2:IR:STATES:IN": "L'ingresso è il bus interno",
    "EP2:IR:STATES:OUT": "L'uscita va al selettore IR e alla CU",
    "EP2:IR:SIGNALS:C3": "Conferma che l'ingresso è memorizzato",
    "EP2:RT1:STATES:IN": "L'ingresso è il bus interno",
    "EP2:RT1:STATES:OUT": "L'uscita va al tristato T4",
    "EP2:RT1:SIGNALS:CTL": "Conferma che l'ingresso è memorizzato",
    "EP2:RT2:STATES:IN": "L'ingresso è il bus interno",
    "EP2:RT2:STATES:OUT": "L'uscita va al tristato T5",
    "EP2:RT2:SIGNALS:CTL": "Conferma che l'ingresso è memorizzato",
    "EP2:RT3:STATES:IN": "L'ingresso è l'uscita dell'ALU",
    "EP2:RT3:STATES:OUT": "L'uscita va al tristato T7",
    "EP2:RT3:SIGNALS:CTL": "Conferma che l'ingresso è memorizzato",
    "EP2:SR:STATES:IN": "L'ingresso è l'uscita dell'M7",
    "EP2:SR:STATES:OUT": "L'uscita va all'ingresso T8 e alla CU",
    "EP2:SR:SIGNALS:CTL": "Conferma che l'ingresso è memorizzato",
    "EP2:REGISTER_FILE:STATES:A": "Uscita di RF a T9 e MA/0",
    "EP2:REGISTER_FILE:STATES:B": "Uscita di RF a T10 e MB/0",
    "EP2:REGISTER_FILE:STATES:C": "Ingresso a RF dal bus interno",
    "EP2:REGISTER_FILE:SIGNALS:RA": "Seleziona il registro il cui valore viene inviato ad A",
    "EP2:REGISTER_FILE:SIGNALS:RB": "Seleziona il registro il cui valore viene inviato a B",
    "EP2:REGISTER_FILE:SIGNALS:RC": "Seleziona il registro in cui è memorizzato il valore di C",
    "EP2:REGISTER_FILE:SIGNALS:LC": "Conferma che RC sta per essere aggiornato",
    "EP2:CPU_ALU:STATES:A": "Uscita da multiplexor MUX A",
    "EP2:CPU_ALU:STATES:B": "Uscita da multiplexor MUX B",
    "EP2:CPU_ALU:STATES:ALU": "Il risultato va all'ingresso di T6 e RT3",
    "EP2:CPU_ALU:STATES:FLAGS": "Flag C,V,N,Z aggiornate",
    "EP2:CPU_ALU:SIGNALS:COP": "Codice operazione (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "Ingresso 1 di SELECT-SR, flag U",
    "EP2:SELECT_SR:STATES:MUX_2": "Ingresso 2 di SELECT-SR, flag I",
    "EP2:SELECT_SR:STATES:MUX_3": "Ingresso 3 di SELECT-SR, flag C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "Uscita su MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "Seleziona il valore di ingresso da inviare all'uscita",
    "EP2:SELECT_IR:STATES:MUX_I": "Ingresso di SELECT-IR da IR",
    "EP2:SELECT_IR:STATES:MUX_O": "Uscita al bus interno tramite T3",
    "EP2:SELECT_IR:SIGNALS:SE": "Estensione firma",
    "EP2:SELECT_IR:SIGNALS:SIZE": "Dimensione",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "Offset",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "Ingresso dal registro MBR",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "Ingresso dal bus dati",
    "EP2:BYTE_SELECTOR:STATES:BE": "Uscita su BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "Uscita su M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "Uscita su Td/ingresso",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "Scrivi nella memoria principale",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "Estensione firma",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "Numero di byte da comprimere",
    "EP2:MEMORY:STATES:ADDR": "Bus indirizzi",
    "EP2:MEMORY:STATES:DATA": "Bus dati",
    "EP2:MEMORY:STATES:MRDY": "Memoria pronta",
    "EP2:MEMORY:SIGNALS:BE": "BW+A1A0",
    "EP2:MEMORY:SIGNALS:R": "Leggi",
    "EP2:MEMORY:SIGNALS:W": "Scrivi",
    "EP2:IO:STATES:ADDR": "Bus indirizzo",
    "EP2:IO:STATES:DATA": "Bus dati",
    "EP2:IO:SIGNALS:IOR": "Leggi dal dispositivo IO",
    "EP2:IO:SIGNALS:IOW": "Scrivi nell'IO Device",
    "EP2:KEYBOARD:STATES:ADDR": "Bus indirizzi",
    "EP2:KEYBOARD:STATES:DATA": "Bus dati",
    "EP2:KEYBOARD:SIGNALS:IOR": "Leggi da tastiera",
    "EP2:DISPLAY:STATES:ADDR": "Bus indirizzi",
    "EP2:DISPLAY:STATES:DATA": "Bus dati",
    "EP2:DISPLAY:SIGNALS:IOR": "Lettura da display (disabilitato)",
    "EP2:DISPLAY:SIGNALS:IOW": "Scrivi sul display",
    "EP2:L3D:STATES:ADDR": "Bus indirizzi",
    "EP2:L3D:STATES:DATA": "Bus dati",
    "EP2:L3D:SIGNALS:IOR": "Leggi da L3D",
    "EP2:L3D:SIGNALS:IOW": "Scrivi nell'L3D",
    "EP2:LEDM:STATES:ADDR": "Bus indirizzi",
    "EP2:LEDM:STATES:DATA": "Bus dati",
    "EP2:LEDM:SIGNALS:IOR": "Leggi da LEDM",
    "EP2:LEDM:SIGNALS:IOW": "Scrivi nell'LEDM",
    "EP2:SOUND:STATES:ADDR": "Bus indirizzi",
    "EP2:SOUND:STATES:DATA": "Bus dati",
    "EP2:SOUND:SIGNALS:IOR": "Leggi dalla scheda audio.",
    "EP2:SOUND:SIGNALS:IOW": "Scrivi sulla scheda audio.",
