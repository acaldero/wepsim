...
i18n.eltos.hw.zh_cn = {
    ...
    "EP:SOUND:STATES:ADDR": "地址總線",
    "EP:SOUND:STATES:DATA": "數據總線",
    "EP:SOUND:SIGNALS:IOR": "从声卡读取数据。",
    "EP:SOUND:SIGNALS:IOW": "向声卡写入数据。",
    "EP2:CPU_T1:STATES:IN": "輸入是 MBR 寄存器的",
    "EP2:CPU_T1:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T1:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T2:STATES:IN": "輸入是PC寄存器的值",
    "EP2:CPU_T2:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T2:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T3:STATES:IN": "輸入是選擇器-IR的輸出",
    "EP2:CPU_T3:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T3:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T4:STATES:IN": "輸入為 RT1 寄存器的值",
    "EP2:CPU_T4:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T4:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T5:STATES:IN": "輸入為 RT2 寄存器的值",
    "EP2:CPU_T5:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T5:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T6:STATES:IN": "輸入是 ALU 輸出",
    "EP2:CPU_T6:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T6:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T7:STATES:IN": "輸入為 RT3 寄存器的值",
    "EP2:CPU_T7:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T7:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T8:STATES:IN": "輸入是SR寄存器的值",
    "EP2:CPU_T8:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T8:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T9:STATES:IN": "輸入是寄存器文件端口 A 輸出的值",
    "EP2:CPU_T9:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T9:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T10:STATES:IN": "輸入是寄存器文件端口 B 輸出的值",
    "EP2:CPU_T10:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T10:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T11:STATES:IN": "輸入是微指令/ExCode 輸出",
    "EP2:CPU_T11:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T11:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_T12:STATES:IN": "输入是 HPC（硬件性能计数器）输出",
    "EP2:CPU_T12:STATES:OUT": "輸出到內部總線",
    "EP2:CPU_T12:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_TA:STATES:IN": "輸入是MAR寄存器輸出",
    "EP2:CPU_TA:STATES:OUT": "輸出到地址總線",
    "EP2:CPU_TA:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_TB:STATES:IN": "輸入是字節選擇器輸出",
    "EP2:CPU_TB:STATES:OUT": "輸出到數據總線",
    "EP2:CPU_TB:SIGNALS:CTL": "確認輸入值被複製到輸出",
    "EP2:CPU_MUX_A:STATES:MUX_0": "從寄存器文件 (A) 中輸入 MUX A 的 0",
    "EP2:CPU_MUX_A:STATES:MUX_1": "MUX A 的輸入 1，來自 RT1 寄存器",
    "EP2:CPU_MUX_A:STATES:MUX_O": "輸出到 ALU，操作符 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "選擇要發送到輸出的輸入值",
    "EP2:CPU_MUX_B:STATES:MUX_0": "從寄存器文件 (B) 中輸入 MUX B 的 0",
    "EP2:CPU_MUX_B:STATES:MUX_1": "MUX B 的輸入 1，來自 RT2 寄存器",
    "EP2:CPU_MUX_B:STATES:MUX_2": "MUX B 的輸入 2，值為 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "MUX B 的輸入 3，值為 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "輸出到 ALU，操作員 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "選擇要發送到輸出的輸入值",
    "EP2:CPU_MUX_1:STATES:MUX_0": "從內部總線輸入 MUX 1 的 0",
    "EP2:CPU_MUX_1:STATES:MUX_1": "MUX 1 的輸入 1，來自字節選擇器",
    "EP2:CPU_MUX_1:STATES:MUX_O": "從 MUX 1 輸出到 MBR",
    "EP2:CPU_MUX_1:SIGNALS:M1": "選擇要發送到輸出的輸入值",
    "EP2:CPU_MUX_2:STATES:MUX_0": "從內部總線輸入 MUX 2 的 0",
    "EP2:CPU_MUX_2:STATES:MUX_1": "MUX 2 的輸入 1, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "輸出到 PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "選擇要發送到輸出的輸入值",
    "EP2:CPU_MUX_7:STATES:MUX_0": "從內部總線輸入 MUX 7 的 0",
    "EP2:CPU_MUX_7:STATES:MUX_1": "MUX 7 的輸入 1，來自標誌選擇器",
    "EP2:CPU_MUX_7:STATES:MUX_O": "輸出到寄存器 SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "選擇要發送到輸出的輸入值",
    "EP2:CU_MUX_A:STATES:MUX_0": "MUX A 的輸入 0，來自 microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "MUX A 的輸入 1，來自 co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "MUX A 的輸入 2，來自 microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "MUX A 的輸入 3，從 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "從 MUX A 輸出到 microADDR",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "控制單元 MUX B 的輸出",
    "EP2:CU_MUX_B:STATES:MUX_0": "MUX B 的輸入 0，來自 MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "MUX B 的輸入 1，來自 NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "輸出到 MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "選擇要發送到輸出的輸入值",
    "EP2:CU_MUX_C:STATES:MUX_0": "MUX C 的輸入 0，從 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "MUX C 的輸入 1，來自 INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "MUX C 的輸入 2，來自 IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "MUX C 的輸入 3，來自 MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "MUX C 的輸入 4，來自 SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "MUX C 的輸入 5，來自 SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "MUX C 的輸入 6，來自 SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "MUX C 的輸入 7，來自 SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "MUX C 的輸入 8，來自 SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "MUX C 的輸入 9，來自 SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "MUX C 的輸入 10，來自 InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "輸出到 MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "控制單元 MUX C 的輸出",
    "EP2:CU_MUX_RA:STATES:MUX_0": "MUX MR 的輸入 0，來自 IR[SelA+0...SelA+4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "MUX MR 的輸入 1，來自 SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "輸出到 RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "選擇要發送到輸出的輸入值",
    "EP2:CU_MUX_RB:STATES:MUX_0": "MUX MR 的輸入 0，來自 IR[SelB+0...SelB+4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "MUX MR 的輸入 1，來自 SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "輸出到 RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "選擇要發送到輸出的輸入值",
    "EP2:CU_MUX_RC:STATES:MUX_0": "MUX MR 的輸入 0，來自 IR[SelC+0...SelC+4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "MUX MR 的輸入 1，來自 SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "輸出到 RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "選擇要發送到輸出的輸入值",
    "EP2:CU_MUX_MC:STATES:MUX_0": "MUX MC 的輸入 0，來自 IR3...IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "MUX MC 的輸入 1，來自 SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "輸出到 COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "選擇要發送到輸出的輸入值",
    "EP2:CPU_MUX_H:STATES:MUX_0": "硬件性能计数器的 MUX H 的输入 0",
    "EP2:CPU_MUX_H:STATES:MUX_1": "硬件性能计数器的 MUX H 的输入 1",
    "EP2:CPU_MUX_H:STATES:MUX_2": "硬件性能计数器的 MUX H 的输入 2",
    "EP2:CPU_MUX_H:STATES:MUX_3": "硬件性能计数器的 MUX H 的输入 3",
    "EP2:CPU_MUX_H:STATES:MUX_O": "输出到 T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "选择要发送到输出的输入值",
    "EP2:MAR:STATES:IN": "輸入是內部總線",
    "EP2:MAR:STATES:OUT": "輸出到 Ta 三態",
    "EP2:MAR:SIGNALS:C0": "確認輸入已存儲",
    "EP2:MBR:STATES:IN": "輸入是 M1 輸出",
    "EP2:MBR:STATES:OUT": "輸出到 T1 三態",
    "EP2:MBR:SIGNALS:C1": "確認輸入已存儲",
    "EP2:PC:STATES:IN": "輸入是 M2 輸出",
    "EP2:PC:STATES:OUT": "輸出到 T2 三態",
    "EP2:PC:SIGNALS:CTL": "確認輸入已存儲",
    "EP2:IR:STATES:IN": "輸入是內部總線",
    "EP2:IR:STATES:OUT": "輸出到 IR 選擇器和 CU",
    "EP2:IR:SIGNALS:C3": "確認輸入已存儲",
    "EP2:RT1:STATES:IN": "輸入是內部總線",
    "EP2:RT1:STATES:OUT": "輸出到 T4 三態",
    "EP2:RT1:SIGNALS:CTL": "確認輸入已存儲",
    "EP2:RT2:STATES:IN": "輸入是內部總線",
    "EP2:RT2:STATES:OUT": "輸出到 T5 三態",
    "EP2:RT2:SIGNALS:CTL": "確認輸入已存儲",
    "EP2:RT3:STATES:IN": "輸入是 ALU 的輸出",
    "EP2:RT3:STATES:OUT": "輸出到 T7 三態",
    "EP2:RT3:SIGNALS:CTL": "確認輸入已存儲",
    "EP2:SR:STATES:IN": "EP2:SR:STATES:IN”： “輸入是M7的輸出",
    "EP2:SR:STATES:OUT": "輸出到 T8 輸入和 CU",
    "EP2:SR:SIGNALS:CTL": "確認輸入已存儲",
    "EP2:REGISTER_FILE:STATES:A": "RF 輸出到 T9 和 MA/0",
    "EP2:REGISTER_FILE:STATES:B": "RF 輸出到 T10 和 MB/0",
    "EP2:REGISTER_FILE:STATES:C": "從內部總線輸入到 RF",
    "EP2:REGISTER_FILE:SIGNALS:RA": "選擇將值發送到 A 的寄存器",
    "EP2:REGISTER_FILE:SIGNALS:RB": "選擇發送到 B 的寄存器",
    "EP2:REGISTER_FILE:SIGNALS:RC": "選擇存儲 C 值的寄存器",
    "EP2:REGISTER_FILE:SIGNALS:LC": "確認 RC 將被更新",
    "EP2:CPU_ALU:STATES:A": "MUX A 多路復用器的輸出",
    "EP2:CPU_ALU:STATES:B": "MUX B 多路復用器的輸出",
    "EP2:CPU_ALU:STATES:ALU": "結果進入 T6 和 RT3 的輸入",
    "EP2:CPU_ALU:STATES:FLAGS": "更新了 C、V、N、Z 標誌",
    "EP2:CPU_ALU:SIGNALS:COP": "操作代碼 (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "SELECT-SR 的輸入 1，U 標誌",
    "EP2:SELECT_SR:STATES:MUX_2": "SELECT-SR 的輸入 2，I 標誌",
    "EP2:SELECT_SR:STATES:MUX_3": "SELECT-SR 的輸入 3，標誌 C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "輸出到 MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "選擇要發送到輸出的輸入值",
    "EP2:SELECT_IR:STATES:MUX_I": "來自 IR 的 SELECT-IR 輸入",
    "EP2:SELECT_IR:STATES:MUX_O": "通過 T3 輸出到內部總線",
    "EP2:SELECT_IR:SIGNALS:SE": "符號擴展",
    "EP2:SELECT_IR:SIGNALS:SIZE": "尺寸",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "偏移量",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "來自 MBR 寄存器的輸入",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "來自數據總線的輸入",
    "EP2:BYTE_SELECTOR:STATES:BE": "輸出到 BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "輸出到 M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "輸出到 Td/輸入",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "寫入主內存",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "符號擴展",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "要打包的字節數",
    "EP2:MEMORY:STATES:ADDR": "地址總線",
    "EP2:MEMORY:STATES:DATA": "數據總線",
    "EP2:MEMORY:STATES:MRDY": "內存就緒",
    "EP2:MEMORY:SIGNALS:BE": "BW+A1A0",
    "EP2:MEMORY:SIGNALS:R": "讀取",
    "EP2:MEMORY:SIGNALS:W": "寫入",
    "EP2:IO:STATES:ADDR": "地址總線",
    "EP2:IO:STATES:DATA": "數據總線",
    "EP2:IO:SIGNALS:IOR": "從 IO 設備讀取",
    "EP2:IO:SIGNALS:IOW": "寫入 IO 設備",
    "EP2:KEYBOARD:STATES:ADDR": "地址總線",
    "EP2:KEYBOARD:STATES:DATA": "數據總線",
    "EP2:KEYBOARD:SIGNALS:IOR": "從鍵盤讀取",
    "EP2:DISPLAY:STATES:ADDR": "地址總線",
    "EP2:DISPLAY:STATES:DATA": "數據總線",
    "EP2:DISPLAY:SIGNALS:IOR": "從顯示器讀取（禁用）",
    "EP2:DISPLAY:SIGNALS:IOW": "寫入顯示器",
    "EP2:L3D:STATES:ADDR": "地址總線",
    "EP2:L3D:STATES:DATA": "數據總線",
    "EP2:L3D:SIGNALS:IOR": "從 L3D 讀取",
    "EP2:L3D:SIGNALS:IOW": "寫入 L3D",
    "EP2:LEDM:STATES:ADDR": "地址總線",
    "EP2:LEDM:STATES:DATA": "數據總線",
    "EP2:LEDM:SIGNALS:IOR": "從 LEDM 讀取",
    "EP2:LEDM:SIGNALS:IOW": "寫入 LEDM",
    "EP2:SOUND:STATES:ADDR": "地址總線",
    "EP2:SOUND:STATES:DATA": "數據總線",
    "EP2:SOUND:SIGNALS:IOR": "从声卡读取数据。",
    "EP2:SOUND:SIGNALS:IOW": "向声卡写入数据。",
