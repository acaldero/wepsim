...
i18n.eltos.hw.fr = {
    ...
    "EP2:CPU_T1:STATES:IN": "L'entrée est la valeur du registre MBR",
    "EP2:CPU_T1:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T1:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T2:STATES:IN": "L'entrée est la valeur du registre PC",
    "EP2:CPU_T2:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T2:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T3:STATES:IN": "L'entrée est la sortie du sélecteur-IR",
    "EP2:CPU_T3:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T3:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T4:STATES:IN": "L'entrée est la valeur du registre RT1",
    "EP2:CPU_T4:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T4:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T5:STATES:IN": "L'entrée est la valeur du registre RT2",
    "EP2:CPU_T5:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T5:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T6:STATES:IN": "L'entrée est la sortie ALU",
    "EP2:CPU_T6:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T6:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_T7:STATES:IN": "L'entrée est la valeur du registre RT3",
    "EP2:CPU_T7:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T7:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_T8:STATES:IN": "L'entrée est la valeur du registre SR",
    "EP2:CPU_T8:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T8:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_T9:STATES:IN": "L'entrée est la valeur de la sortie du port A du fichier de registre",
    "EP2:CPU_T9:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T9:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T10:STATES:IN": "L'entrée est la valeur de la sortie du port B du fichier de registre",
    "EP2:CPU_T10:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T10:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée vers la sortie",
    "EP2:CPU_T11:STATES:IN": "L'entrée est la sortie de la micro-instruction/ExCode",
    "EP2:CPU_T11:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T11:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_T12:STATES:IN": "L'entrée est la sortie HPC (compteur de performance matérielle)",
    "EP2:CPU_T12:STATES:OUT": "La sortie va au bus interne",
    "EP2:CPU_T12:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_TA:STATES:IN": "L'entrée est la sortie du registre MAR",
    "EP2:CPU_TA:STATES:OUT": "La sortie va au bus d'adresse",
    "EP2:CPU_TA:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_TB:STATES:IN": "L'entrée est la sortie du sélecteur d'octets",
    "EP2:CPU_TB:STATES:OUT": "La sortie va au bus de données",
    "EP2:CPU_TB:SIGNALS:CTL": "Confirmez que la valeur d'entrée est copiée dans la sortie",
    "EP2:CPU_MUX_A:STATES:MUX_0": "Entrée 0 du MUX A, à partir du fichier de registre (A)",
    "EP2:CPU_MUX_A:STATES:MUX_1": "Entrée 1 du MUX A, du registre RT1",
    "EP2:CPU_MUX_A:STATES:MUX_O": "Sortie vers ALU, opérateur 0",
    "EP2:CPU_MUX_A:SIGNALS:MA": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CPU_MUX_B:STATES:MUX_0": "Entrée 0 du MUX B, à partir du fichier de registre (B)",
    "EP2:CPU_MUX_B:STATES:MUX_1": "Entrée 1 du MUX B, du registre RT2",
    "EP2:CPU_MUX_B:STATES:MUX_2": "Entrée 2 du MUX B, valeur 4",
    "EP2:CPU_MUX_B:STATES:MUX_3": "Entrée 3 du MUX B, valeur 1",
    "EP2:CPU_MUX_B:STATES:MUX_O": "Sortie vers ALU, opérateur 1",
    "EP2:CPU_MUX_B:SIGNALS:MB": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CPU_MUX_1:STATES:MUX_0": "Entrée 0 du MUX 1, du bus interne",
    "EP2:CPU_MUX_1:STATES:MUX_1": "Entrée 1 du MUX 1, du sélecteur d'octet",
    "EP2:CPU_MUX_1:STATES:MUX_O": "Sortie vers MBR, à partir du MUX 1",
    "EP2:CPU_MUX_1:SIGNALS:M1": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CPU_MUX_2:STATES:MUX_0": "Entrée 0 du MUX 2, du bus interne",
    "EP2:CPU_MUX_2:STATES:MUX_1": "Entrée 1 de MUX 2, PC + 4",
    "EP2:CPU_MUX_2:STATES:MUX_O": "Sortie vers PC",
    "EP2:CPU_MUX_2:SIGNALS:M2": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CPU_MUX_7:STATES:MUX_0": "Entrée 0 du MUX 7, du bus interne",
    "EP2:CPU_MUX_7:STATES:MUX_1": "Entrée 1 du MUX 7, du sélecteur de drapeau",
    "EP2:CPU_MUX_7:STATES:MUX_O": "Sortie pour enregistrer SR",
    "EP2:CPU_MUX_7:SIGNALS:M7": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CU_MUX_A:STATES:MUX_0": "Entrée 0 du MUX A, de microADDR + 1",
    "EP2:CU_MUX_A:STATES:MUX_1": "Entrée 1 du MUX A, de co2maddr",
    "EP2:CU_MUX_A:STATES:MUX_2": "Entrée 2 du MUX A, du microIR/MADDR",
    "EP2:CU_MUX_A:STATES:MUX_3": "Entrée 3 du MUX A, à partir de 0",
    "EP2:CU_MUX_A:STATES:MUX_O": "Sortie vers microADDR, du MUX A",
    "EP2:CU_MUX_A:SIGNALS:A0": "mIR/A0",
    "EP2:CU_MUX_A:SIGNALS:A1": "Sortie de l'unité de contrôle MUX B",
    "EP2:CU_MUX_B:STATES:MUX_0": "Entrée 0 du MUX B, du MUX C",
    "EP2:CU_MUX_B:STATES:MUX_1": "Entrée 1 du MUX B, de NOT (MUX C)",
    "EP2:CU_MUX_B:STATES:MUX_O": "Sortie vers MUX A/A1",
    "EP2:CU_MUX_B:SIGNALS:MB": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CU_MUX_C:STATES:MUX_0": "Entrée 0 du MUX C, à partir de 0",
    "EP2:CU_MUX_C:STATES:MUX_1": "Entrée 1 du MUX C, de INT",
    "EP2:CU_MUX_C:STATES:MUX_2": "Entrée 2 du MUX C, de IORdy",
    "EP2:CU_MUX_C:STATES:MUX_3": "Entrée 3 du MUX C, de MRdy",
    "EP2:CU_MUX_C:STATES:MUX_4": "Entrée 4 du MUX C, de SR/U",
    "EP2:CU_MUX_C:STATES:MUX_5": "Entrée 5 du MUX C, de SR/I",
    "EP2:CU_MUX_C:STATES:MUX_6": "Entrée 6 du MUX C, de SR/Z",
    "EP2:CU_MUX_C:STATES:MUX_7": "Entrée 7 du MUX C, de SR/N",
    "EP2:CU_MUX_C:STATES:MUX_8": "Entrée 8 du MUX C, de SR/V",
    "EP2:CU_MUX_C:STATES:MUX_9": "Entrée 9 du MUX C, de SR/C",
    "EP2:CU_MUX_C:STATES:MUX_10": "Entrée 10 du MUX C, depuis InEx",
    "EP2:CU_MUX_C:STATES:MUX_O": "Sortie vers MUX B",
    "EP2:CU_MUX_C:SIGNALS:CTL": "Sortie de l'unité de contrôle MUX C",
    "EP2:CU_MUX_RA:STATES:MUX_0": "Entrée 0 du MUX MR, de IR[SelA+0...SelA+4]",
    "EP2:CU_MUX_RA:STATES:MUX_1": "Entrée 1 du MUX MR, de SelA",
    "EP2:CU_MUX_RA:STATES:MUX_O": "Sortie vers RA",
    "EP2:CU_MUX_RA:SIGNALS:CTL": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CU_MUX_RB:STATES:MUX_0": "Entrée 0 du MUX MR, de IR[SelB+0...SelB+4]",
    "EP2:CU_MUX_RB:STATES:MUX_1": "Entrée 1 du MUX MR, de SelB",
    "EP2:CU_MUX_RB:STATES:MUX_O": "Sortie vers RB",
    "EP2:CU_MUX_RB:SIGNALS:MR": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CU_MUX_RC:STATES:MUX_0": "Entrée 0 du MUX MR, de IR[SelC+0...SelC+4]",
    "EP2:CU_MUX_RC:STATES:MUX_1": "Entrée 1 du MUX MR, de SelC",
    "EP2:CU_MUX_RC:STATES:MUX_O": "Sortie vers RC",
    "EP2:CU_MUX_RC:SIGNALS:MR": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CU_MUX_MC:STATES:MUX_0": "Entrée 0 du MUX MC, de IR3...IR0",
    "EP2:CU_MUX_MC:STATES:MUX_1": "Entrée 1 du MUX MC, de SelCop",
    "EP2:CU_MUX_MC:STATES:MUX_O": "Sortie vers COP",
    "EP2:CU_MUX_MC:SIGNALS:CTL": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:CPU_MUX_H:STATES:MUX_0": "Entrée 0 du MUX H, du compteur de performances matérielles",
    "EP2:CPU_MUX_H:STATES:MUX_1": "Entrée 1 du MUX H, du compteur de performances matérielles",
    "EP2:CPU_MUX_H:STATES:MUX_2": "Entrée 2 du MUX H, du compteur de performances matérielles",
    "EP2:CPU_MUX_H:STATES:MUX_3": "Entrée 3 du MUX H, du compteur de performances matérielles",
    "EP2:CPU_MUX_H:STATES:MUX_O": "Sortie vers T12",
    "EP2:CPU_MUX_H:SIGNALS:MH": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:MAR:STATES:IN": "L'entrée est le bus interne",
    "EP2:MAR:STATES:OUT": "La sortie va au tristate Ta",
    "EP2:MAR:SIGNALS:C0": "Confirmez que l'entrée est stockée",
    "EP2:MBR:STATES:IN": "L'entrée est la sortie M1",
    "EP2:MBR:STATES:OUT": "La sortie va au tristate T1",
    "EP2:MBR:SIGNALS:C1": "Confirmez que l'entrée est stockée",
    "EP2:PC:STATES:IN": "L'entrée est la sortie M2",
    "EP2:PC:STATES:OUT": "La sortie va au tristate T2",
    "EP2:PC:SIGNALS:CTL": "Confirmez que l'entrée est stockée",
    "EP2:IR:STATES:IN": "L'entrée est le bus interne",
    "EP2:IR:STATES:OUT": "La sortie va au sélecteur IR et à la CU",
    "EP2:IR:SIGNALS:C3": "Confirmez que l'entrée est stockée",
    "EP2:RT1:STATES:IN": "L'entrée est le bus interne",
    "EP2:RT1:STATES:OUT": "La sortie va au tristate T4",
    "EP2:RT1:SIGNALS:CTL": "Confirmez que l'entrée est stockée",
    "EP2:RT2:STATES:IN": "L'entrée est le bus interne",
    "EP2:RT2:STATES:OUT": "La sortie va au tristate T5",
    "EP2:RT2:SIGNALS:CTL": "Confirmez que l'entrée est stockée",
    "EP2:RT3:STATES:IN": "L'entrée est la sortie de l'ALU",
    "EP2:RT3:STATES:OUT": "La sortie va au tristate T7",
    "EP2:RT3:SIGNALS:CTL": "Confirmez que l'entrée est stockée",
    "EP2:SR:STATES:IN": "L'entrée est la sortie du M7",
    "EP2:SR:STATES:OUT": "La sortie va à l'entrée T8 et à la CU",
    "EP2:SR:SIGNALS:CTL": "Confirmez que l'entrée est stockée",
    "EP2:REGISTER_FILE:STATES:A": "Sortie de RF vers T9 et MA/0",
    "EP2:REGISTER_FILE:STATES:B": "Sortie de RF vers T10 et MB/0",
    "EP2:REGISTER_FILE:STATES:C": "Entrée vers RF à partir du bus interne",
    "EP2:REGISTER_FILE:SIGNALS:RA": "Sélectionnez le registre dont la valeur est envoyée à A",
    "EP2:REGISTER_FILE:SIGNALS:RB": "Sélectionnez le registre dont la valeur est envoyée à B",
    "EP2:REGISTER_FILE:SIGNALS:RC": "Sélectionnez le registre où la valeur de C est stockée",
    "EP2:REGISTER_FILE:SIGNALS:LC": "Confirmez que RC va être mis à jour",
    "EP2:CPU_ALU:STATES:A": "Sortie du multiplexeur MUX A",
    "EP2:CPU_ALU:STATES:B": "Sortie du multiplexeur MUX B",
    "EP2:CPU_ALU:STATES:ALU": "Le résultat va à l'entrée de T6 et RT3",
    "EP2:CPU_ALU:STATES:FLAGS": "Mises à jour des drapeaux C,V,N,Z",
    "EP2:CPU_ALU:SIGNALS:COP": "Code opération (+, -, *, ...)",
    "EP2:SELECT_SR:STATES:MUX_1": "Entrée 1 de SELECT-SR, drapeau U",
    "EP2:SELECT_SR:STATES:MUX_2": "Entrée 2 de SELECT-SR, je flag",
    "EP2:SELECT_SR:STATES:MUX_3": "Entrée 3 de SELECT-SR, flags C V N Z",
    "EP2:SELECT_SR:STATES:MUX_O": "Sortie vers MUX 7/1",
    "EP2:SELECT_SR:SIGNALS:SELP": "Sélectionnez la valeur d'entrée à envoyer à la sortie",
    "EP2:SELECT_IR:STATES:MUX_I": "Entrée de SELECT-IR depuis IR",
    "EP2:SELECT_IR:STATES:MUX_O": "Sortie vers le bus interne via T3",
    "EP2:SELECT_IR:SIGNALS:SE": "Signer l'extension",
    "EP2:SELECT_IR:SIGNALS:SIZE": "Taille",
    "EP2:SELECT_IR:SIGNALS:OFFSET": "Décalage",
    "EP2:BYTE_SELECTOR:STATES:FROM_MBR": "Entrée du registre MBR",
    "EP2:BYTE_SELECTOR:STATES:FROM_DATA": "Entrée du bus de données",
    "EP2:BYTE_SELECTOR:STATES:BE": "Sortie vers BE",
    "EP2:BYTE_SELECTOR:STATES:TO_MBR": "Sortie vers M1/1",
    "EP2:BYTE_SELECTOR:STATES:TO_TD": "Sortie vers Td/entrée",
    "EP2:BYTE_SELECTOR:SIGNALS:W": "Écrire dans la mémoire principale",
    "EP2:BYTE_SELECTOR:SIGNALS:SE": "Signer l'extension",
    "EP2:BYTE_SELECTOR:SIGNALS:A1A0": "A1A0",
    "EP2:BYTE_SELECTOR:SIGNALS:BW": "Nombre d'octets à emballer",
    "EP2:MEMORY:STATES:ADDR": "Bus d'adresses",
    "EP2:MEMORY:STATES:DATA": "Bus de données",
    "EP2:MEMORY:STATES:MRDY": "Mémoire prête",
    "EP2:MEMORY:SIGNALS:BE": "BW+A1A0",
    "EP2:MEMORY:SIGNALS:R": "Lire",
    "EP2:MEMORY:SIGNALS:W": "Ecrire",
    "EP2:IO:STATES:ADDR": "Bus d'adresses",
    "EP2:IO:STATES:DATA": "Bus de données",
    "EP2:IO:SIGNALS:IOR": "Lire depuis le périphérique IO",
    "EP2:IO:SIGNALS:IOW": "Écrire dans le périphérique IO",
    "EP2:KEYBOARD:STATES:ADDR": "Bus d'adresses",
    "EP2:KEYBOARD:STATES:DATA": "Bus de données",
    "EP2:KEYBOARD:SIGNALS:IOR": "Lire depuis le clavier",
    "EP2:DISPLAY:STATES:ADDR": "Bus d'adresses",
    "EP2:DISPLAY:STATES:DATA": "Bus de données",
    "EP2:DISPLAY:SIGNALS:IOR": "Lire à partir de l'affichage (désactivé)",
    "EP2:DISPLAY:SIGNALS:IOW": "Écrire dans l'écran",
    "EP2:L3D:STATES:ADDR": "Bus d'adresses",
    "EP2:L3D:STATES:DATA": "Bus de données",
    "EP2:L3D:SIGNALS:IOR": "Lire depuis L3D",
    "EP2:L3D:SIGNALS:IOW": "Écrire dans le L3D",
    "EP2:LEDM:STATES:ADDR": "Bus d'adresses",
    "EP2:LEDM:STATES:DATA": "Bus de données",
    "EP2:LEDM:SIGNALS:IOR": "Lire depuis LEDM",
    "EP2:LEDM:SIGNALS:IOW": "Écrire dans le LEDM",
    "EP2:SOUND:STATES:ADDR": "Bus d'adresses",
    "EP2:SOUND:STATES:DATA": "Bus de données",
    "EP2:SOUND:SIGNALS:IOR": "Lire depuis la carte son",
    "EP2:SOUND:SIGNALS:IOW": "Écrire sur la carte son",
