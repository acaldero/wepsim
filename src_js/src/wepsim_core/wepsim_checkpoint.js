...
export function wepsim_checkpoint_NB_concat_ws_cells(cells) {
    ...
    cells.push({
        ...
        "source": [
            ...
            "   !wget https://github.com/wepsim/wepsim/releases/download/v2.4.2/wepsim-2.4.2.zip >& /dev/null\n",
            "   !unzip -o wepsim-2.4.2.zip  >& /dev/null\n",
            "   !rm -fr   wepsim-2.4.2.zip\n",
            "   !./wepsim-2.4.2/wepsim.sh -a stepbystep -m ep -f /base.mc -s /base.asm > ./result.csv\n",
            "\n",
            "df = None\n",
            "if ws['assembly'] != '' and ws['firmware'] != '':\n",
            "   import pandas as pd\n",
...
export function wepsim_checkpoint_loadURI(obj_uri) {
    ...
    try {
        ...
        wepsim_url_json(obj_uri.href, function (data) {
