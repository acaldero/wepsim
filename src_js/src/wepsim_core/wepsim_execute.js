...
import { simcore_reset, simcore_check_if_can_execute, simcore_execute_microprogram, simcore_execute_microinstruction, simcore_execute_microinstruction_backwards, simcore_check_if_can_continue, simcore_execute_microinstruction2 } from "../sim_core/sim_api_core.js";
...
export function wepsim_check_memdashboard(ref_mdash, notif_origin) {
    ...
    if (notifications > 1) {
        ...
        if ('offcanvas' == ret.showas)
            ...
            wepsim_memdashboard_notify_dialogbox(ref_mdash, notif_origin, notifications, ret.skip1stline);
...
export function wepsim_execute_chainplay(wepsim_execute_stop) {
    ...
    if ((DBG_limit_instruction > dbg_limit_ins) && (dbg_limit_ins > 0)) {
        wepsim_show_stopbyevent("Limit", "Number of executed instructions limit reached.<br>" +
            "<br>" +
