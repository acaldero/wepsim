        ...
        'action': function (hash) {
            ...
            try {
                if ('cache' == hash.mc) {
                    ...
                    if (null == mc_code)
                        throw new Error("null decompressed data from hash.mc :-(");
                }
        ...
        'action': function (hash) {
            ...
            try {
                if ('cache' == hash.asm) {
                    ...
                    if (null == asm_code)
                        throw new Error("null decompressed data from hash.asm :-(");
                }
                result_txt = ' has been loaded';
            }
            catch (e) {
        ...
        'action': function (hash) {
            ...
            try {
                if ('cache' == hash.asm) {
                    ...
                    if (null == cm_cfg_json)
                        throw new Error("null decompressed data from hash.cache :-(");
                }
                result_txt = ' has been loaded';
            }
            catch (e) {
