...
export function sim_tutorial_goframe(tutorial_name, from_step, to_step) {
    ...
    setTimeout(function () { sim_tutorial_showframe(tutorial_name, to_step); }, tutorial[from_step].wait_next);
...
export function sim_tutorial_showframe(tutorial_name, step) {
    ...
    simcore_ga('help', 'help.tutorial', 'help.tutorial=' + tutorial_name + ',step=' + step);
    // 3.- code_pre
