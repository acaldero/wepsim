 ...
 *
 */
import { restore_cfg, reset_cfg_values, get_cfg, set_cfg } from "./sim_cfg.js";
import { show_asmdbg_pc, show_dbg_ir, show_dbg_mpc, ws_alert } from "./sim_core_ui.js";
import { get_value, set_value } from "./sim_core_values.js";
import { get_simware, set_simware, ws_info } from "./sim_adt_core.js";
import { update_memories } from "./sim_core_ctrl.js";
import { simcore_simstate_saveCurrent, simcore_simstate_restoreCurrent, simcore_simstate_current2state } from "./sim_api_stateshots.js";
import { simhw_getIdByName, simhw_setActive, simhw_sim_components, simhw_sim_signals, simhw_sim_signal, simhw_internalState, simhw_internalState_get, simhw_sim_ctrlStates_get, simhw_sim_state, simhw_sim_state_getref, simhw_getObjByName, simhw_add } from "../sim_hw/sim_hw_index.js";
import { compute_general_behavior } from "../sim_hw/sim_hw_behavior.js";
import { loadFirmware } from "../sim_sw/firmware.js";
import { wsasm_src2mem, wsasm_src2binsrc } from "../sim_sw/assembly.js";
import { hash_detail2init } from "../wepsim_web/wepsim_web_simulator.js";
import { hash_detail2action, hash_signal2action } from "../wepsim_web/wepsim_web_api.js";
...
export function simcore_action_ui(component_name, detail_id, action_name) {
    ...
    var action = (_c = (_b = (_a = sim_components[component_name]) === null || _a === void 0 ? void 0 : _a.details_ui) === null || _b === void 0 ? void 0 : _b[detail_id]) === null || _c === void 0 ? void 0 : _c[action_name];
    // if action is "undefined" then return "simcore_do_nothing_handler", otherwise action is returned
    return action !== null && action !== void 0 ? action : simcore_do_nothing_handler;
}
/**
...
export function simcore_reset() {
    ...
    if (curr_firm.stackRegister != null) {
        ...
        if (simware_registers_keys.length > 1)
            ...
            ctrl_states.sp.state = 'BR.' + sp_name;
...
export function simcore_execute_program(options) {
    ...
    var ins_executed = 0;
    while (((reg_pc < code_end) && (reg_pc >= code_begin)) ||
...
export function simcore_hardware_import(hw_json) {
    ...
    // import json
    // based on: https://stackoverflow.com/questions/36517173/how-to-store-a-javascript-function-in-json
    var hw_obj = JSON.parse(hw_json, function (key, value) {
