...
import { simhw_internalState, simhw_sim_signal, simhw_sim_state, simhw_internalState_set, simhw_internalState_get, simhw_sim_ctrlStates_get, simhw_internalState_reset } from "../sim_hw/sim_hw_index.js";
import { update_draw, update_bus_visibility, ws_alert, show_memories_values, show_main_memory, show_control_memory, show_cache_memory } from "./sim_core_ui.js";
/*
 *  base
 */
...
export async function wait_if_uievents(function1, recommended_timeout) {
    var _a;
    if ((_a = globalThis.scheduler) === null || _a === void 0 ? void 0 : _a.yield) {
...
export function propage_signal_update(key) {
    if (true === get_cfg('is_interactive')) {
        ...
        if (signal_obj.value != signal_obj.default_value)
            ...
            delete (simhw_sim_state("REG_MICROINS").value[key]);
        // update MC[uADDR]
        var maddr_name = simhw_sim_ctrlStates_get().mpc.state;
