...
import { simhw_sim_ctrlStates_get, simhw_sim_state, simhw_internalState_get } from "../sim_hw/sim_hw_index.js";
...
export function control_memory_set(memory, elto, melto) {
    ...
    if (typeof melto.notify === "undefined")
        melto.notify = [];
    if (typeof melto.is_native === "undefined")
        melto.is_native = false;
