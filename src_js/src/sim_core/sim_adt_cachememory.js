...
import { segments_addr_within_text, segments_addr_within_data } from "../sim_sw/assembly/memory_segments.js";
/*
 *  cache_memory => {
 *               "stats": {
 *                           n_access:     0,
...
export function cache_memory_init_eltofromcfg(cfg) {
    return cache_memory_init(get_var(cfg.name), get_var(cfg.via_size), get_var(cfg.off_size), get_var(cfg.set_size), get_var(cfg.replace_pol), get_var(cfg.su_pol), get_var(cfg.level), get_var(cfg.next_cache));
...
export function cache_memory_update_eltofromcfg(cfg) {
    return cache_memory_update(get_var(cfg.name), get_var(cfg.via_size), get_var(cfg.off_size), get_var(cfg.set_size), get_var(cfg.replace_pol), get_var(cfg.su_pol), get_var(cfg.level), get_var(cfg.next_cache));
}
