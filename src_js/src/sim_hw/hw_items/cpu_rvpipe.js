...
import { hw_states_save, hw_states_load } from "../sim_hw_state.js";
import { hw_signals_save, hw_signals_load, jit_fire_order, signal_apply_behaviour } from "../sim_hw_signal.js";
 ...
 */
export function cpu_rvpipe_register(sim_p) {
    function create_op(behavior, ...signals_or_states) {
    ...
    sim_p.components["CPU"] =
        {
            ...
            write_state: function (vec) {
                ...
                for (var idx in sim_p.states.BR) {
                    if (typeof sim_p.states.BR[idx] === "undefined")
                        continue;
    ...
    let STATES;
    (function (STATES) {
        STATES["REG_PC"] = "REG_PC";
        STATES["IF_FETCH_PC"] = "IF_FETCH_PC";
        STATES["M1_ALU"] = "M1_ALU";
        STATES["M2_ALU"] = "M2_ALU";
        STATES["M3_ALU"] = "M3_ALU";
        STATES["M4_ALU"] = "M4_ALU";
        STATES["M5_ADDR"] = "M5_ADDR";
        STATES["M5_DATA"] = "M5_DATA";
        STATES["M6_OUT"] = "M6_OUT";
        STATES["OUT_MUX_BRANCH"] = "OUT_MUX_BRANCH";
        STATES["OUT_MUX_JUMP_INT"] = "OUT_MUX_JUMP_INT";
        STATES["OUT_MUX_ALUOUT"] = "OUT_MUX_ALUOUT";
        STATES["ALU_OUT"] = "ALU_OUT";
        STATES["R_DATA1"] = "R_DATA1";
        STATES["R_DATA2"] = "R_DATA2";
        STATES["T_INT"] = "T_INT";
        STATES["T_INTA"] = "T_INTA";
        STATES["T_INTV"] = "T_INTV";
        STATES["IORdy"] = "IORdy";
        STATES["BUS_DB"] = "BUS_DB";
        STATES["BUS_AB"] = "BUS_AB";
        STATES["MUX_DMR_OUT"] = "MUX_DMR_OUT";
        STATES["IF_ID_IR"] = "IF_ID_IR";
        STATES["IF_ID_PC"] = "IF_ID_PC";
        STATES["ID_EX_RS1"] = "ID_EX_RS1";
        STATES["ID_EX_RS2"] = "ID_EX_RS2";
        STATES["ID_EX_RS1_ADDR"] = "ID_EX_RS1_ADDR";
        STATES["ID_EX_RS2_ADDR"] = "ID_EX_RS2_ADDR";
        STATES["ID_EX_RD"] = "ID_EX_RD";
        STATES["ID_EX_ALUOP"] = "ID_EX_ALUOP";
        STATES["ID_EX_M3"] = "ID_EX_M3";
        STATES["ID_EX_M4"] = "ID_EX_M4";
        STATES["ID_EX_M5"] = "ID_EX_M5";
        STATES["ID_EX_M6"] = "ID_EX_M6";
        STATES["ID_EX_IMM"] = "ID_EX_IMM";
        STATES["ID_EX_PC"] = "ID_EX_PC";
        STATES["ID_EX_RW"] = "ID_EX_RW";
        STATES["ID_EX_DMR"] = "ID_EX_DMR";
        STATES["ID_EX_DMW"] = "ID_EX_DMW";
        STATES["ID_EX_WBE"] = "ID_EX_WBE";
        STATES["ID_EX_SE"] = "ID_EX_SE";
        STATES["ID_EX_BRANCH"] = "ID_EX_BRANCH";
        STATES["ID_EX_IOR"] = "ID_EX_IOR";
        STATES["ID_EX_IOW"] = "ID_EX_IOW";
        STATES["EX_MEM_M5"] = "EX_MEM_M5";
        STATES["EX_MEM_M6"] = "EX_MEM_M6";
        STATES["EX_MEM_ALUOUT"] = "EX_MEM_ALUOUT";
        STATES["EX_MEM_WDATA"] = "EX_MEM_WDATA";
        STATES["EX_MEM_RD"] = "EX_MEM_RD";
        STATES["EX_MEM_RW"] = "EX_MEM_RW";
        STATES["EX_MEM_PC"] = "EX_MEM_PC";
        STATES["EX_MEM_DMR"] = "EX_MEM_DMR";
        STATES["EX_MEM_DMW"] = "EX_MEM_DMW";
        STATES["EX_MEM_WBE"] = "EX_MEM_WBE";
        STATES["EX_MEM_SE"] = "EX_MEM_SE";
        STATES["EX_MEM_IOR"] = "EX_MEM_IOR";
        STATES["EX_MEM_IOW"] = "EX_MEM_IOW";
        STATES["MEM_WB_M6"] = "MEM_WB_M6";
        STATES["MEM_WB_DATA"] = "MEM_WB_DATA";
        STATES["MEM_WB_ALUOUT"] = "MEM_WB_ALUOUT";
        STATES["MEM_WB_RD"] = "MEM_WB_RD";
        STATES["MEM_WB_RW"] = "MEM_WB_RW";
        STATES["MEM_WB_PC"] = "MEM_WB_PC";
        STATES["DECODE_DMR"] = "DECODE_DMR";
        STATES["DECODE_DMW"] = "DECODE_DMW";
        STATES["DECODE_WBE"] = "DECODE_WBE";
        STATES["DECODE_SE"] = "DECODE_SE";
        STATES["DECODE_RS1_ADDR"] = "DECODE_RS1_ADDR";
        STATES["DECODE_RS2_ADDR"] = "DECODE_RS2_ADDR";
        STATES["DECODE_RD_ADDR"] = "DECODE_RD_ADDR";
        STATES["DECODE_ALUOP"] = "DECODE_ALUOP";
        STATES["DECODE_M3"] = "DECODE_M3";
        STATES["DECODE_M4"] = "DECODE_M4";
        STATES["DECODE_M5"] = "DECODE_M5";
        STATES["DECODE_M6"] = "DECODE_M6";
        STATES["DECODE_BRANCH"] = "DECODE_BRANCH";
        STATES["DECODE_SE_IMM"] = "DECODE_SE_IMM";
        STATES["DECODE_X2_IMM"] = "DECODE_X2_IMM";
        STATES["DECODE_OFFSET"] = "DECODE_OFFSET";
        STATES["DECODE_SIZE"] = "DECODE_SIZE";
        STATES["DECODE_RW"] = "DECODE_RW";
        STATES["DECODE_IOR"] = "DECODE_IOR";
        STATES["DECODE_IOW"] = "DECODE_IOW";
        STATES["RDATA"] = "RDATA";
        STATES["RDATAM"] = "RDATAM";
        STATES["VAL_ZERO"] = "VAL_ZERO";
        STATES["VAL_ONE"] = "VAL_ONE";
        STATES["VAL_TWO"] = "VAL_TWO";
        STATES["VAL_THREE"] = "VAL_THREE";
        STATES["VAL_FOUR"] = "VAL_FOUR";
        STATES["VAL_IMM"] = "VAL_IMM";
        STATES["VAL_SEPC"] = "VAL_SEPC";
        STATES["CLK"] = "CLK";
        STATES["DDR"] = "DDR";
        STATES["DSR"] = "DSR";
        STATES["KBDR"] = "KBDR";
        STATES["KBSR"] = "KBSR";
        STATES["REG_IR_DECO"] = "REG_IR_DECO";
        STATES["REG_MICROADDR"] = "REG_MICROADDR";
        STATES["MUXA_MICROADDR"] = "MUXA_MICROADDR";
        STATES["REG_MICROINS"] = "REG_MICROINS";
        STATES["DECO_INS"] = "DECO_INS";
        STATES["ACC_TIME"] = "ACC_TIME";
        STATES["TTCPU"] = "TTCPU";
        STATES["BRANCH_TARGET"] = "BRANCH_TARGET";
        STATES["REG_EPC"] = "REG_EPC";
        STATES["OUT_EPC_MUX_IF_PC_IF_ID_PC"] = "OUT_EPC_MUX_IF_PC_IF_ID_PC";
        STATES["INT_MEM_READ"] = "INT_MEM_READ";
        STATES["INTV_X_4"] = "INTV_X_4";
        STATES["BR"] = "BR";
    })(STATES || (STATES = {}));
    ;
    let SIGNALS;
    (function (SIGNALS) {
        SIGNALS["ADDER_TARGET"] = "ADDER_TARGET";
        SIGNALS["PIPE_FETCH"] = "PIPE_FETCH";
        SIGNALS["RW"] = "RW";
        SIGNALS["PIPE_DECODE"] = "PIPE_DECODE";
        SIGNALS["PCWRITE"] = "PCWRITE";
        SIGNALS["EPCWRITE"] = "EPCWRITE";
        SIGNALS["SE_IMM"] = "SE_IMM";
        SIGNALS["SIZE"] = "SIZE";
        SIGNALS["OFFSET"] = "OFFSET";
        SIGNALS["X2_IMM"] = "X2_IMM";
        SIGNALS["M1"] = "M1";
        SIGNALS["M2"] = "M2";
        SIGNALS["M3"] = "M3";
        SIGNALS["M4"] = "M4";
        ...
        SIGNALS["M6"] = "M6";
        SIGNALS["IMR"] = "IMR";
        SIGNALS["AUX_LOAD_ALUOP"] = "AUX_LOAD_ALUOP";
        SIGNALS["MUX_ALUOUT"] = "MUX_ALUOUT";
        SIGNALS["AUX_LOAD_MUX_ALUOUT"] = "AUX_LOAD_MUX_ALUOUT";
        SIGNALS["AUX_LOAD_BRANCH"] = "AUX_LOAD_BRANCH";
        SIGNALS["AUX_LOAD_M5"] = "AUX_LOAD_M5";
        SIGNALS["AUX_LOAD_M6"] = "AUX_LOAD_M6";
        SIGNALS["ALUOP"] = "ALUOP";
        SIGNALS["WBE"] = "WBE";
        SIGNALS["SE"] = "SE";
        SIGNALS["IOR"] = "IOR";
        SIGNALS["IOW"] = "IOW";
        SIGNALS["IOCHK"] = "IOCHK";
        SIGNALS["DB_UPDATED"] = "DB_UPDATED";
        SIGNALS["CLK"] = "CLK";
        SIGNALS["AUX_LOAD_MEM"] = "AUX_LOAD_MEM";
        SIGNALS["DMR"] = "DMR";
        SIGNALS["MUX_DMR"] = "MUX_DMR";
        SIGNALS["DMW"] = "DMW";
        SIGNALS["INT"] = "INT";
        SIGNALS["INTV"] = "INTV";
        SIGNALS["ALU_INT"] = "ALU_INT";
        SIGNALS["ALU_INTV"] = "ALU_INTV";
        SIGNALS["IF_ID_RST"] = "IF_ID_RST";
        SIGNALS["ID_EX_RST"] = "ID_EX_RST";
        SIGNALS["EX_MEM_RST"] = "EX_MEM_RST";
        SIGNALS["MEM_WB_RST"] = "MEM_WB_RST";
        SIGNALS["AUX_LOAD_MUX_STALL"] = "AUX_LOAD_MUX_STALL";
        SIGNALS["MUX_STALL_IF_ID"] = "MUX_STALL_IF_ID";
        SIGNALS["MUX_STALL_ID_EX"] = "MUX_STALL_ID_EX";
        SIGNALS["BRANCH"] = "BRANCH";
        SIGNALS["BRANCH_IS_ONE"] = "BRANCH_IS_ONE";
        SIGNALS["BRANCH_IS_TWO"] = "BRANCH_IS_TWO";
        SIGNALS["BRANCH_IS_THREE"] = "BRANCH_IS_THREE";
        SIGNALS["BRANCH_OR"] = "BRANCH_OR";
        SIGNALS["BRANCH_AND"] = "BRANCH_AND";
        SIGNALS["BRANCH_STALL_NOT"] = "BRANCH_STALL_NOT";
        SIGNALS["STALL"] = "STALL";
        SIGNALS["JUMP"] = "JUMP";
        SIGNALS["AUX_DRAW_FORWARDING_UNIT"] = "AUX_DRAW_FORWARDING_UNIT";
        SIGNALS["HAZARD_NEQ_RD_0"] = "HAZARD_NEQ_RD_0";
        SIGNALS["HAZARD_OR_DMR_IOR"] = "HAZARD_OR_DMR_IOR";
        SIGNALS["HAZARD_AND"] = "HAZARD_AND";
        SIGNALS["HAZARD_AND_AND_OR"] = "HAZARD_AND_AND_OR";
        SIGNALS["HAZARD_EQ_RD_RS1"] = "HAZARD_EQ_RD_RS1";
        SIGNALS["HAZARD_EQ_RD_RS2"] = "HAZARD_EQ_RD_RS2";
        SIGNALS["HAZARD_OR_RS1_RS2"] = "HAZARD_OR_RS1_RS2";
        SIGNALS["HAZARD_SEPC_EQ_BRANCH_3"] = "HAZARD_SEPC_EQ_BRANCH_3";
        SIGNALS["HAZARD_SEPC_EQ_RD_SEPC"] = "HAZARD_SEPC_EQ_RD_SEPC";
        SIGNALS["HAZARD_SEPC_AND"] = "HAZARD_SEPC_AND";
        SIGNALS["HAZARD_OR_STALL"] = "HAZARD_OR_STALL";
        SIGNALS["FORWARD_EQ_MEM_WB_RD_ID_EX_RS1"] = "FORWARD_EQ_MEM_WB_RD_ID_EX_RS1";
        SIGNALS["FORWARD_NEQ_MEM_WB_RD_0"] = "FORWARD_NEQ_MEM_WB_RD_0";
        SIGNALS["FORWARD_EQ_MEM_WB_RD_ID_EX_RS2"] = "FORWARD_EQ_MEM_WB_RD_ID_EX_RS2";
        SIGNALS["FORWARD_AND_MEM_WB_RW"] = "FORWARD_AND_MEM_WB_RW";
        SIGNALS["FORWARD_AND_MEM_WB_1"] = "FORWARD_AND_MEM_WB_1";
        SIGNALS["FORWARD_AND_MEM_WB_2"] = "FORWARD_AND_MEM_WB_2";
        SIGNALS["FORWARD_EQ_EX_MEM_RD_ID_EX_RS1"] = "FORWARD_EQ_EX_MEM_RD_ID_EX_RS1";
        SIGNALS["FORWARD_NEQ_EX_MEM_RD_0"] = "FORWARD_NEQ_EX_MEM_RD_0";
        SIGNALS["FORWARD_EQ_EX_MEM_RD_ID_EX_RS2"] = "FORWARD_EQ_EX_MEM_RD_ID_EX_RS2";
        SIGNALS["FORWARD_AND_EX_MEM_RW"] = "FORWARD_AND_EX_MEM_RW";
        SIGNALS["FORWARD_AND_EX_MEM_1"] = "FORWARD_AND_EX_MEM_1";
        SIGNALS["FORWARD_AND_EX_MEM_2"] = "FORWARD_AND_EX_MEM_2";
        SIGNALS["FORWARD_MUX_M1"] = "FORWARD_MUX_M1";
        SIGNALS["FORWARD_MUX_M2"] = "FORWARD_MUX_M2";
        SIGNALS["AUX_LOAD_INT_MUX"] = "AUX_LOAD_INT_MUX";
        SIGNALS["INT_MUX_INT"] = "INT_MUX_INT";
        SIGNALS["INT_MUX_INTV"] = "INT_MUX_INTV";
        SIGNALS["INT_EQ_0_JUMP_BR"] = "INT_EQ_0_JUMP_BR";
        SIGNALS["INT_EQ_0_STALL"] = "INT_EQ_0_STALL";
        SIGNALS["INT_EQ_0_EPC"] = "INT_EQ_0_EPC";
        SIGNALS["INT_AND"] = "INT_AND_INT_AND";
        SIGNALS["JUMP_INT"] = "JUMP_INT";
        SIGNALS["JUMP_BR"] = "JUMP_BR";
        SIGNALS["JUMP_OR_INT_BR"] = "JUMP_OR_INT_BR";
        SIGNALS["EPC_EQ_0_IF_ID_PC"] = "EPC_EQ_0_IF_ID_PC";
        SIGNALS["EPC_MUX_IF_PC_IF_ID_PC"] = "EPC_MUX_IF_PC_IF_ID_PC";
        SIGNALS["AUX_LOAD_MUX_EPCWRITE"] = "AUX_LOAD_MUX_EPCWRITE";
        SIGNALS["MUX_EPCWRITE"] = "MUX_EPCWRITE";
        SIGNALS["AUX_LOAD_MUX_JUMP_INT"] = "AUX_LOAD_MUX_JUMP_INT";
        SIGNALS["INTV_X_4"] = "INTV_X_4";
        SIGNALS["MEM_JUMP_INT"] = "MEM_JUMP_INT";
        SIGNALS["MUX_JUMP_INT"] = "MUX_JUMP_INT";
    })(SIGNALS || (SIGNALS = {}));
    ;
    let BEHAVIORS;
    (function (BEHAVIORS) {
        BEHAVIORS["NOP"] = "NOP";
        BEHAVIORS["NOP_ALU"] = "NOP_ALU";
        BEHAVIORS["ECALL_ALU"] = "ECALL_ALU";
        BEHAVIORS["GET"] = "GET";
        BEHAVIORS["SET"] = "SET";
        BEHAVIORS["MV"] = "MV";
        BEHAVIORS["MV_BITS"] = "MV_BITS";
        BEHAVIORS["AND"] = "AND";
        BEHAVIORS["OR"] = "OR";
        BEHAVIORS["XOR"] = "XOR";
        BEHAVIORS["NOT"] = "NOT";
        ...
        BEHAVIORS["SLTU"] = "SLTU";
        BEHAVIORS["SGEU"] = "SGEU";
        BEHAVIORS["READ_IM"] = "READ_IM";
        BEHAVIORS["FIRE"] = "FIRE";
        BEHAVIORS["FIRE_IFSET"] = "FIRE_IFSET";
        BEHAVIORS["DECO_IMM"] = "DECO_IMM";
        BEHAVIORS["UPDATE_ALU_INT"] = "UPDATE_ALU_INT";
        BEHAVIORS["CPU_RESET"] = "CPU_RESET";
        BEHAVIORS["REFRESH"] = "REFRESH";
        BEHAVIORS["PIPE_IF"] = "PIPE_IF";
        BEHAVIORS["PIPE_DECO"] = "PIPE_DECO";
        BEHAVIORS["PIPE_WB_WRITE"] = "PIPE_WB_WRITE";
        BEHAVIORS["PIPE_DISPLAY"] = "PIPE_DISPLAY";
        BEHAVIORS["SCR_IOR"] = "SCR_IOR";
        BEHAVIORS["SCR_IOW"] = "SCR_IOW";
        BEHAVIORS["KBD_IOR"] = "KBD_IOR";
        BEHAVIORS["MEM_READ"] = "MEM_READ";
        BEHAVIORS["MEM_WRITE"] = "MEM_WRITE";
        BEHAVIORS["STALL_UNIT"] = "STALL_UNIT";
        BEHAVIORS["CLOCK"] = "CLOCK";
        BEHAVIORS["IO_CHK"] = "IO_CHK";
        BEHAVIORS["INTA"] = "INTA";
        BEHAVIORS["AND_NOT"] = "AND_NOT";
        BEHAVIORS["HISTORY_SAVE"] = "HISTORY_SAVE";
        BEHAVIORS["HISTORY_RESTORE"] = "HISTORY_RESTORE";
    })(BEHAVIORS || (BEHAVIORS = {}));
    ;
    let CSR;
    (function (CSR) {
        CSR[CSR["sstatus"] = 256] = "sstatus";
        CSR[CSR["sie"] = 260] = "sie";
        CSR[CSR["stvec"] = 261] = "stvec";
        CSR[CSR["scounteren"] = 262] = "scounteren";
        CSR[CSR["sscratch"] = 320] = "sscratch";
        CSR[CSR["sepc"] = 321] = "sepc";
        CSR[CSR["scause"] = 322] = "scause";
        CSR[CSR["stval"] = 323] = "stval";
        CSR[CSR["sip"] = 324] = "sip";
    })(CSR || (CSR = {}));
    ;
    /*
    ...
    sim_p.behaviors[BEHAVIORS.ECALL_ALU] = {
        ...
        verbal: function (s_expr) { return "ALU interruption ECALL. "; }
    };
    // GET ref BR num
    sim_p.behaviors[BEHAVIORS.GET] = {
        ...
        operation: function (s_expr) {
            ...
            set_value(ref, value);
            if (DEBUG)
                console.log(s_expr, "Set value", value, "to", ref.name);
        },
    ...
    sim_p.behaviors[BEHAVIORS.SET] = {
        ...
        operation: function (s_expr) {
            ...
            if (DEBUG)
                console.log(s_expr, "Set value", value, "to BR", num);
        },
        verbal: function (s_expr) {
            const br = sim_p.states[s_expr[1]];
            const num = parseInt(s_expr[2]);
    ...
    sim_p.behaviors[BEHAVIORS.AND_NOT] = {
        ...
        operation: function (s_expr) {
            ...
            if (DEBUG)
                console.log("val1", val1.toString(2), "val2", val2.toString(2), (~val2).toString(2), "result", result.toString(2));
            set_value(get_reference(s_expr[1]), result >>> 0);
            sim_p.internal_states.alu_flags.int = 0;
            sim_p.internal_states.alu_flags.intv = 0;
        },
    ...
    sim_p.behaviors[BEHAVIORS.ADD] = {
        ...
        operation: function (s_expr) {
            ...
            set_value(sim_p.states[s_expr[1]], result >>> 0);
            if (DEBUG)
                console.log("ALU ADD ", a, "+", b, "=", result);
            sim_p.internal_states.alu_flags.int = 0;
            sim_p.internal_states.alu_flags.intv = 0;
        },
        verbal: function (s_expr) {
    ...
    sim_p.behaviors[BEHAVIORS.READ_IM] = {
        ...
        operation: function (s_expr) {
            ...
            if ((typeof sim_p.events.mem[clk - 1] != "undefined") &&
    ...
    function fire(key) {
        var _a, _b;
        if (DEBUG)
            console.log("Start FIRE", key, "value", (_a = sim_p.signals[key]) === null || _a === void 0 ? void 0 : _a.value, "fire_once", sim_p.internal_states.fire_once[key]);
        if (sim_p.internal_states.fire_once[key]) {
            if (DEBUG)
                console.log("return already fire");
            return;
        }
        const signal = sim_p.signals[key];
        if (typeof signal == "undefined") {
            if (DEBUG)
                console.log("return not a signal");
            return;
        }
        ...
        if (deps) {
            for (const d of deps) {
                // L:  only L
                // E: L and E
                const signal_dep_type = (_b = sim_p.signals[d]) === null || _b === void 0 ? void 0 : _b.type;
        ...
        if (DEBUG)
            console.log("FIRE", key, "value", get_value(sim_p.signals[key]));
    ...
    sim_p.behaviors[BEHAVIORS.DECO_IMM] = {
        ...
        operation: function (s_expr) {
            ...
            const oi = decode_instruction(sim_p.internal_states.FIRMWARE, sim_p.ctrl_states.ir, ins);
            ...
            if (DEBUG)
                console.log(JSON.stringify(s_expr), "Value:", get_value(sim_p.states[dest_state]));
        },
    ...
    sim_p.behaviors[BEHAVIORS.CPU_RESET] = {
        ...
        verbal: function () { return "Reset CPU. "; }
    };
    sim_p.behaviors[BEHAVIORS.HISTORY_SAVE] = {
        ...
        verbal: function () { return "History saved. "; }
    };
    sim_p.behaviors[BEHAVIORS.HISTORY_RESTORE] = {
        ...
        verbal: function () { return "History restored. "; }
    };
    sim_p.behaviors[BEHAVIORS.REFRESH] = {
        ...
        verbal: function () { return "Refresh CPU svg. "; }
    };
    function inBounds(pc) {
    ...
    sim_p.behaviors[BEHAVIORS.PIPE_IF] = {
        ...
        operation: function (s_expr) {
            ...
            if (DEBUG)
                console.log("PIPE_IF pc_val=" + pc_val.toString(16) + " in_bounds=" + in_bounds);
            if (in_bounds) {
        ...
        verbal: function (s_expr) { return "Fetch instruction at PC. "; }
    };
    sim_p.behaviors[BEHAVIORS.PIPE_DECO] = {
        ...
        operation: function (s_expr) {
            ...
            for (let i = 0; i < oi.oinstruction.fields.length; i++) {
                ...
                if (field.type == "reg") {
                    let bs = (field.bits !== undefined) ? field.bits : [[field.startbit, field.stopbit]];
            ...
            if (typeof sim_p.states.BR[reg_rs1] !== "undefined") {
                ...
                if (DEBUG)
                    console.log("Read rs1 from", reg_rs1, "value", value);
            }
            if (typeof sim_p.states.BR[reg_rs2] !== "undefined") {
                ...
                if (DEBUG)
                    console.log("Read rs2 from", reg_rs2, "value", value);
            }
            ...
            if (oi.oinstruction.microcode && oi.oinstruction.microcode.length > 0) {
                ...
                for (let key in micro) {
                    if (DEBUG)
                        console.log("PIPE_DECO " + key + "=" + micro[key] + " type=" + typeof micro[key]);
            ...
            sim_p.behaviors[BEHAVIORS.DECO_IMM].operation([BEHAVIORS.DECO_IMM, STATES.VAL_IMM, STATES.IF_ID_IR, SIGNALS.OFFSET, SIGNALS.SIZE, SIGNALS.SE_IMM, SIGNALS.X2_IMM]);
            let decins = get_deco_from_pc(get_value(sim_p.states[STATES.IF_ID_PC]));
            set_value(sim_p.states[STATES.REG_IR_DECO], decins);
            show_dbg_ir(decins);
        },
        verbal: function (s_expr) { return "Decode instruction using microcode. "; }
    };
    sim_p.behaviors[BEHAVIORS.PIPE_WB_WRITE] = {
        ...
        operation: function (s_expr) {
            ...
            if (rw && rd != 0) {
                ...
                if (DEBUG)
                    console.log("Save value", data, "in reg", rd, sim_p.states.BR[rd].name);
            }
        },
        verbal: function (s_expr) { return "Write back to register file. "; }
    };
    sim_p.behaviors[BEHAVIORS.PIPE_DISPLAY] = {
        ...
        verbal: function (s_expr) { return "Update pipeline display. "; }
    };
    sim_p.behaviors[BEHAVIORS.CLOCK] = {
        ...
        operation: function () {
            ...
            // ====================================================================
            for (const key of jit_fire_order !== null && jit_fire_order !== void 0 ? jit_fire_order : []) {
            ...
            // ====================================================================
            sim_p.behaviors[BEHAVIORS.GET].operation([BEHAVIORS.GET, STATES.REG_EPC, STATES.BR, CSR.sepc.toString()]);
            sim_p.behaviors[BEHAVIORS.IO_CHK].operation([BEHAVIORS.IO_CHK, STATES.T_INT, STATES.T_INTV, STATES.REG_EPC]);
            // ====================================================================
    ...
    function show_pipeline_display_table() {
        if (typeof $ === "undefined")
            return;
    ...
    function show_pipeline_display_svg() {
