...
import { hw_signals_save, hw_signals_load, signal_fire, signal_apply_behaviour_allByEdge, signal_update_draw_allByEdge, signal_apply_behaviour_allByLevel, signal_reset_and_apply } from "../sim_hw_signal.js";
/*
 *  CPU
 */
export function cpu_ep2_register(sim_p) {
    ...
    sim_p.behaviors["MBIT_SELX"] = { nparameters: 6,
        ...
        operation: function (s_expr) {
            ...
            if (typeof sim_p.states[s_expr[3]].value[s_expr[4]] != "undefined")
                ...
                ws_alert('WARN: undefined field from REG_MINS -> ' + s_expr[3] + '/' + s_expr[4]);
    ...
    sim_p.behaviors["MOVE_BITS"] = { nparameters: 5,
        ...
        operation: function (s_expr) {
            ...
            m1 = m1 & n2;
            ; // get first 32-(posd+len) bits of n2
            var m2 = (1 << posd) - 1; // mask: 000...000 11111 (last 'posd' bits to '1')
            m2 = m2 & n2;
            ; // get last 'posd' bits of n2
