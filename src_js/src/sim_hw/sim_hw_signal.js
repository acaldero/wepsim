...
import { simhw_sim_signals, simhw_sim_signal } from "./sim_hw_index.js";
import { ws_alert, update_draw } from "../sim_core/sim_core_ui.js";
/*
 *  Model/signals (function simhw_signal_...(){})
 */
export var jit_fire_dep = null;
export var jit_fire_order = null;
export var jit_fire_ndep = null;
export var jit_fire_order_E = null;
export var jit_fire_order_L = null;
export var fire_array_isfiring = []; // to avoid loops: M1->...->M1
/*
 * API
 */
export function set_jit_fire_dep(new_jit_fire_dep) {
    jit_fire_dep = new_jit_fire_dep;
}
export function get_jit_fire_dep() {
    return jit_fire_dep;
}
...
export function signal_apply_behaviour_allByEdge(mc_elto) {
    if ((typeof mc_elto == "undefined") || (mc_elto.is_native)) { // skip signal activation if undefined OR is_native
        return;
    }
