...
import { wsasm_has_datatype_attr, wsasm_get_datatype_size } from "./directives.js";
//
    ...
    for (let i = 0; i < ret.obj.length; i++) {
        ...
        if ('instruction' == ret.obj[i].datatype) {
            ...
            for (let j = 0; j < ret.obj[i].value.length; j++) {
                ...
                wsasm_writememory_and_accumulate_part(ret.mp, gen, valuebin, ret.obj[i].track_source[j], [], ret.obj[i].comments);
            }
        }
