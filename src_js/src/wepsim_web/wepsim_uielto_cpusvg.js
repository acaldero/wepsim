...
export function wepsim_svg_update_draw(obj, value) {
    ...
    // (different draws)
    {
        ...
        for (i = 0; i < obj.draw_data.length; i++) {
            ...
            for (j = 0; j < obj.draw_data[i].length; j++) {
                wepsim_svg_obj_draw(obj.draw_data[i][j], false, cfg_color_data_active, cfg_color_data_inactive, cfg_size_active, cfg_size_inactive);
            }
        }
        // active one...
        if (typeof obj.draw_data[value] != "undefined") {
            for (j = 0; j < obj.draw_data[value].length; j++) {
                wepsim_svg_obj_draw(obj.draw_data[value][j], draw_it, cfg_color_data_active, cfg_color_data_inactive, cfg_size_active, cfg_size_inactive);
            }
        }
    }
    else if (obj.nbits === 1) 
    // (same draw) && (nbits === 1)
    {
        for (j = 0; j < obj.draw_data[0].length; j++) {
            wepsim_svg_obj_draw(obj.draw_data[0][j], (0 != value) && draw_it, cfg_color_data_active, cfg_color_data_inactive, cfg_size_active, cfg_size_inactive);
        }
    }
    ...
    {
        for (j = 0; j < obj.draw_data[0].length; j++) {
            wepsim_svg_obj_draw(obj.draw_data[0][j], draw_it, cfg_color_data_active, cfg_color_data_inactive, cfg_size_active, cfg_size_inactive);
        }
    }
    ...
    // (different draws)
    {
        ...
        for (i = 0; i < obj.draw_name.length; i++) {
            ...
            for (j = 0; j < obj.draw_name[i].length; j++) {
                wepsim_svg_obj_draw(obj.draw_name[i][j], false, cfg_color_name_active, cfg_color_name_inactive, cfg_size_active, cfg_size_inactive);
            }
        }
        // active one...
        if (typeof obj.draw_name[value] != "undefined") {
            for (j = 0; j < obj.draw_name[value].length; j++) {
                wepsim_svg_obj_draw(obj.draw_name[value][j], draw_it, cfg_color_name_active, cfg_color_name_inactive, cfg_size_active, cfg_size_inactive);
            }
        }
    }
    else if (obj.nbits === 1) 
    // (same draw) && (nbits === 1)
    {
        for (j = 0; j < obj.draw_name[0].length; j++) {
            wepsim_svg_obj_draw(obj.draw_name[0][j], (0 != value) && draw_it, cfg_color_name_active, cfg_color_name_inactive, cfg_size_active, cfg_size_inactive);
        }
    }
    ...
    {
        for (j = 0; j < obj.draw_name[0].length; j++) {
            wepsim_svg_obj_draw(obj.draw_name[0][j], draw_it, cfg_color_name_active, cfg_color_name_inactive, cfg_size_active, cfg_size_inactive);
        }
    }
}
