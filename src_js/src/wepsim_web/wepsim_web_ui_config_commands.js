...
import { i18n_get_selectcfg, i18n_get_TagFor } from "../wepsim_i18n/i18n.js";
import { get_cfg } from "../sim_core/sim_cfg.js";
import { wepsim_config_button_pretoggle, wepsim_show_breakpoint_icon_list, wepsim_show_breakpoint_icon_template, wepsim_config_button_html_onoff, wepsim_config_button_html_2options, wepsim_config_button_html_color, wepsim_config_button_pretoggle_val2, wepsim_config_color_initial } from "./wepsim_web_ui_config.js";
import { wepsim_restore_darkmode, wepsim_uicfg_apply } from "./wepsim_web_simulator.js";
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group d-flex'>" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('NOTIF_delay',2000,'8');\"><span data-langkey='Slow'>Slow</span>" +
        "	    </label>" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('NOTIF_delay',1000,'8');\"><span data-langkey='Normal'>Normal</span>" +
        "	    </label>" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('NOTIF_delay',100,'8');\"><span data-langkey='Fast'>Fast</span>" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('DBG_delay', 200, '12');\"><span data-langkey='Slow'>Slow</span>" +
        "	    </label>" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('DBG_delay', 100, '12');\"><span data-langkey='Normal'>Normal</span>" +
        "	    </label>" +
        ...
        "		   onclick=\"ws.wepsim_config_button_toggle('DBG_delay', 1, '12');\"><span data-langkey='Fast'>Fast</span>" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_init: function () {
        ...
        wepsim_popover_init('#breakpointicon1', popover_cfg, function (shownEvent) {
            wepsim_uicfg_apply();
        });
    },
...
ws_info.config_ui.push({
    ...
    type: "Execution",
    u_class: "",
    code_cfg: wepsim_config_button_html_onoff('4', 'Skip notify: comments', i18n_get_TagFor('cfg', 'Off'), "ws.update_cfg('editor_mode', false);" +
        "ws.wepsim_config_button_toggle('DBG_skip_notifycolon',false,'4');", i18n_get_TagFor('cfg', 'On'), "ws.update_cfg('editor_mode', true);" +
...
ws_info.config_ui.push({
    ...
    type: "Register file",
    u_class: "wsx_morecfg",
    code_cfg: wepsim_config_button_html_2options('3', 'register file display name', "<span data-langkey='Numbers'>Numbers</span>", "numerical", "ws.wepsim_config_button_toggle('RF_display_name','numerical','3'); ws.wepsim_show_rf_names();", "<span data-langkey='Labels'>Labels</span>", "logical", "ws.wepsim_config_button_toggle('RF_display_name','logical','3');   ws.wepsim_show_rf_names();"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Register file",
    u_class: "wsx_morecfg",
    code_cfg: wepsim_config_button_html_onoff('9', 'Is editable', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('is_editable',false,'9');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('is_editable',true,'9');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: wepsim_config_button_html_color('colorpicker1', 'Color for active active data', 'color_data_active'),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Circuitry simulation",
    u_class: "wsx_microcode",
    code_cfg: wepsim_config_button_html_color('colorpicker2', 'Color for active signal name', 'color_name_active'),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: wepsim_config_button_html_onoff('10', 'Is by value', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('is_byvalue',false,'10');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('is_byvalue',true,'10');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Circuitry simulation",
    u_class: "wsx_microcode",
    code_cfg: wepsim_config_button_html_onoff('5', 'Is interactive', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('is_interactive',false,'5');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('is_interactive',true,'5');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Circuitry simulation",
    u_class: "wsx_microcode",
    code_cfg: wepsim_config_button_html_onoff('6', 'Is quick interactive', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('is_quick_interactive',false,'6');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('is_quick_interactive',true,'6');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Accesibility",
    u_class: "wsx_morecfg",
    code_cfg: wepsim_config_button_html_onoff('11', 'Active voice', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('use_voice',false,'11');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('use_voice',true,'11');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Accesibility",
    u_class: "wsx_morecfg",
    code_cfg: wepsim_config_button_html_2options('13', 'Verbose', i18n_get_TagFor('cfg', 'Text'), "text", "ws.wepsim_config_button_toggle('verbal_verbose','text','13');", i18n_get_TagFor('cfg', 'Math'), "math", "ws.wepsim_config_button_toggle('verbal_verbose','math','13');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Accesibility",
    u_class: "",
    code_cfg: wepsim_config_button_html_onoff('16', 'AutoScrolling', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('AS_enable',false,'16');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('AS_enable',true,'16');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Privacy",
    u_class: "",
    code_cfg: wepsim_config_button_html_onoff('17', 'Use Google Analytics', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('use_ga',false,'17');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('use_ga',true,'17');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_cache',false,'14');\">Off" +
        "	    </label>" +
        ...
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_cache',true,'14');\">On" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: true' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_ep2',false,'14');\">Off" +
        "	    </label>" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: false' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_ep2',true,'14');\">On" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: true' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_poc',false,'14');\">Off" +
        "	    </label>" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: false' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('beta_poc',true,'14');\">On" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: true' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('extra_share', false, '14');\">Off" +
        "	    </label>" +
        ...
        "		  class='btn btn-sm w-50 btn-outline-secondary p-1 fw-bold' " +
        "              aria-label='User Interface set of features for WepSIM: false' " +
        "		  onclick=\"ws.wepsim_config_button_toggle2('extra_share', true, '14');\">On" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: "<div class='btn-group btn-group-toggle d-flex' data-bs-toggle='buttons' >" +
        ...
        "		  onclick=\"ws.wepsim_config_button_toggle2('flash_esp32', false, '14');\">Off" +
        "	    </label>" +
        ...
        "		  onclick=\"ws.wepsim_config_button_toggle2('flash_esp32', true, '14');\">On" +
        "	    </label>" +
        "	</div>",
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    type: "Extra Features",
    u_class: "",
    code_cfg: wepsim_config_button_html_onoff('14g', 'History', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle('history_enable', false, '14g'); ws.wepsim_config_button_toggle2('beta_history', false, '14');", i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle('history_enable',  true, '14g'); ws.wepsim_config_button_toggle2('beta_history',  true, '14');"),
    code_init: function () {
...
ws_info.config_ui.push({
    ...
    code_cfg: " <div class='form-group m-0'>" +
        ...
        "            onchange=\"var opt = $(this).find('option:selected');" +
        "                       var optValue = opt.val();" +
        "                       ws.update_cfg('history_size',optValue);\"" +
        "            data-native-menu='false'>" +
