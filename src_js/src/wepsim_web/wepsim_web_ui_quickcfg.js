...
import { i18n_get_TagFor, i18n_update_tags, i18n_get } from "../wepsim_i18n/i18n.js";
import { wepsim_config_button_pretoggle, wepsim_config_button_html_2options, wepsim_config_button_pretoggle_val, wepsim_config_button_html_onoff, wepsim_config_button_html_close } from "./wepsim_web_ui_config.js";
import { wepsim_show_asm_columns_checked, showhideAsmHeader } from "./wepsim_uielto_dbg_asm.js";
    ...
    pomem1: {
        ...
        fun_content: function (shownEvent) {
            return "<div class='container mt-1'>" +
                ...
                quickcfg_html_btn("(*) 0x3B<sub>16</sub>", "ws.update_cfg(\"MEM_display_format\", \"unsigned_16_nofill\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_btn("073<sub>8</sub>", "ws.update_cfg(\"MEM_display_format\", \"unsigned_8_nofill\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_btn("59<sub>10</sub>", "ws.update_cfg(\"MEM_display_format\", \"unsigned_10_nofill\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_btn(";<sub>ascii</sub>", "ws.update_cfg(\"MEM_display_format\", \"char_ascii_nofill\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_br() +
                quickcfg_html_header("Display direction") +
                quickcfg_html_btn("(*) 04 -> 00", "ws.update_cfg(\"MEM_display_direction\", \"h2l\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_btn("00 -> 04", "ws.update_cfg(\"MEM_display_direction\", \"l2h\"); " +
                    "ws.show_memories_values();", "col-6") +
                quickcfg_html_br() +
                quickcfg_html_header("Display segments") +
                quickcfg_html_onoff('19', 'show segments', "(*) " + i18n_get_TagFor('cfg', 'Off'), "  $('#lst_seg1').collapse('hide');" +
                    "  ws.wepsim_config_button_toggle('MEM_show_segments', false, '19');", i18n_get_TagFor('cfg', 'On'), "  $('#lst_seg1').collapse('show');" +
                    "  ws.wepsim_config_button_toggle('MEM_show_segments', true, '19');") +
                quickcfg_html_header("Display origin") +
                quickcfg_html_onoff('20', 'show origin', "(*) " + i18n_get_TagFor('cfg', 'Off'), "  $('.mp_tooltip').collapse('hide');" +
                    "  ws.wepsim_config_button_toggle('MEM_show_source', false, '20');", i18n_get_TagFor('cfg', 'On'), "  $('.mp_tooltip').collapse('show');" +
                    "  ws.wepsim_config_button_toggle('MEM_show_source', true, '20');") +
                quickcfg_html_br() +
                quickcfg_html_header("Number of words") +
                quickcfg_html_btn("(*) 1", "ws.update_cfg(\"MEM_show_nwords\", 1); " +
                    "ws.show_memories_values();", "col-4") +
                quickcfg_html_btn("2", "ws.update_cfg(\"MEM_show_nwords\", 2); " +
                    "ws.show_memories_values();", "col-4") +
                quickcfg_html_btn("3", "ws.update_cfg(\"MEM_show_nwords\", 3); " +
                    "ws.show_memories_values();", "col-4") +
                quickcfg_html_br() +
    ...
    pocpucu1: {
        ...
        fun_content: function (shownEvent) {
            ...
            var o = "<div class='container mt-1 p-1'>" +
                ...
                // <display format>
                quickcfg_html_header('Display format') +
                quickcfg_html_onoff('QD', 'display format', "" + i18n_get_TagFor('cfg', 'Text'), "ws.wepsim_config_button_toggle(\'CPUCU_show_graph\', false, \'QD\');" +
                    "ws.wsweb_cpuview_as_text();" +
                    "$(\'#collapse_text\').show();" +
                    "$(\'#collapse_graph\').hide();" +
                    "return false;", "(*) " + i18n_get_TagFor('cfg', 'Graph'), "ws.wepsim_config_button_toggle(\'CPUCU_show_graph\', true, \'QD\');" +
                ...
                quickcfg_html_onoff('QI', 'is interactive', i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_config_button_toggle(\'is_interactive\',false,\'QI\');", "(*) " + i18n_get_TagFor('cfg', 'On'), "ws.wepsim_config_button_toggle(\'is_interactive\',true,\'QI\');") +
                '</li> ' +
                '</div>' +
                // <filter>
                ...
                wepsim_config_button_html_2options('Q2', 'Text shows inactive elements', "Only active", "false", "var ov = ws.ws_signals_show_inactive;" +
                    "ws.ws_signals_show_inactive=false; $(\'.s-ina\').hide();" +
                    "ws.ws_states_show_inactive =false; $(\'.t-ina\').hide();" +
                    "$('#labelQ2-' + ov).button('toggle');" +
                    "$('#labelQ2-false').button('toggle');", "(*) All", "true", "var ov = ws.ws_signals_show_inactive;" +
...
export function wepsim_init_quickcfg(quick_id, val_trigger, fun_content, fun_ownshown) {
    ...
    return wepsim_popover_init(quick_id, cfg1, function (shownEvent) {
...
export function wepsim_quickcfg_init(qh_id) {
    return wepsim_init_quickcfg(wsweb_quickcfg[qh_id].quick_id, wsweb_quickcfg[qh_id].val_trigger, wsweb_quickcfg[qh_id].fun_content, wsweb_quickcfg[qh_id].fun_ownshown);
}
//
...
export function quickcfg_html_btn(label2, code2, colwidth2) {
...
export function quickcfg_html_btnreg(label2, code2, colwidth2) {
    return "<div class='" + colwidth2 + " p-1 d-grid'>" +
        "<buttom class='btn btn-sm btn-outline-secondary col p-1 text-end float-end' " +
        "        onclick='" + code2 + "; return true;'>" +
...
export function quickcfg_html_onoff(id2, arial2, nm_off2, code_off2, nm_on2, code_on2) {
