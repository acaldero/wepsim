 ...
 *
 */
import { get_cfg, cfg_show_dbg_ir_delay } from "../sim_core/sim_cfg.js";
...
import { WORD_BYTES, WORD_LENGTH, BYTE_LENGTH } from "../sim_sw/assembly/datatypes.js";
import { ws_uielto, register_uielto } from "./wepsim_uielto.js";
import { wepsim_quickcfg_init, quickcfg_html_header, quickcfg_html_onoff } from "./wepsim_web_ui_quickcfg.js";
...
export function default_asmdbg_content_horizontal() {
    ...
    */
    var o = "<br>" +
        default_asmdbg_content_horizontal_card("1", "simulator intro 2", i18n_get('gui', wsi, 'simulator intro 2')) +
        default_asmdbg_content_horizontal_card("2", "simulator intro 3", i18n_get('gui', wsi, 'simulator intro 3'));
    return o;
}
...
export function default_asmdbg_content_vertical() {
    ...
    var o = "<br>" +
        ...
        default_asmdbg_content_vertical_card("1", "simulator intro 1", i18n_get('gui', wsi, 'simulator intro 1')) +
        default_asmdbg_content_vertical_card("2", "simulator intro 2", i18n_get('gui', wsi, 'simulator intro 2')) +
        default_asmdbg_content_vertical_card("3", "simulator intro 3", i18n_get('gui', wsi, 'simulator intro 3')) +
        "</div>" +
        "</div>";
    return o;
}
export function assembly2html(mp, labels, seg) {
    ...
    for (l in mp) {
        ...
        if (mp[l].is_assembly)
            ...
            o += assembly2html_data_row(mp, l, s_label);
    }
    o += "</tbody>" +
        "</table>" +
        "</center>";
...
export function wepsim_show_asm_columns_checked(asm_po) {
    ...
    var o = '<span class="d-grid gap-2 p-1">' +
        ...
        quickcfg_html_onoff('C0', i18n_get('dialogs', wsi, 'Show/Hide labels'), i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_click_asm_columns(\'label\',\'C0\'); ", "(*) " + i18n_get_TagFor('cfg', 'On'), "ws.wepsim_click_asm_columns(\'label\',\'C0\'); ") +
        // <content>
        quickcfg_html_header(i18n_get('dialogs', wsi, 'Show content')) +
        quickcfg_html_onoff('C2', i18n_get('dialogs', wsi, 'Show/Hide content'), i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_click_asm_columns(\'hex\',\'C2\'); ", "(*) " + i18n_get_TagFor('cfg', 'On'), "ws.wepsim_click_asm_columns(\'hex\',\'C2\'); ") +
        // <assembly>
        quickcfg_html_header(i18n_get('dialogs', wsi, 'Show assembly')) +
        quickcfg_html_onoff('C3', i18n_get('dialogs', wsi, 'Show/Hide instruction'), i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_click_asm_columns(\'ins\',\'C3\'); ", "(*) " + i18n_get_TagFor('cfg', 'On'), "ws.wepsim_click_asm_columns(\'ins\',\'C3\'); ") +
        // <pseudo-instructions>
        quickcfg_html_header(i18n_get('dialogs', wsi, 'Show pseudo-instructions')) +
        quickcfg_html_onoff('C4', i18n_get('dialogs', wsi, 'Show/Hide pseudo-instructions'), i18n_get_TagFor('cfg', 'Off'), "ws.wepsim_click_asm_columns(\'pins\',\'C4\'); ", "(*) " + i18n_get_TagFor('cfg', 'On'), "ws.wepsim_click_asm_columns(\'pins\',\'C4\'); ") +
        // <close>
...
export function instruction_oceoc2html(firm_reference) {
    ...
    if (typeof firm_reference.oc !== 'undefined') {
        if (typeof firm_reference.oc.value !== 'undefined')
            ...
            u_oc_eoc += firm_reference.oc; // firmware v1
    }
...
export function instruction_fields2html(firm_reference) {
    ...
    if (typeof fields[0].asm_start_bit !== 'undefined') { // firmware v2
...
export function asmdbg_set_breakpoint(addr) {
    ...
    // add if recording
    simcore_record_append_new('Set assembly breakpoint at ' + addr, 'ws.asmdbg_set_breakpoint(' + addr + ');\n');
}
