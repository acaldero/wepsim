...
export function wepsim_config_dialog_title(name, color, str_onchange) {
...
export function wepsim_config_dialog_dropdown(color, base_buttons, str_onchange) {
    return "<div class='dropdown btn-group'>" +
        base_buttons +
        "<button type='button' " +
        "   data-bs-toggle='dropdown' id='dropdown-title1' " +
...
// button
export function wepsim_config_button_html_onoff(id2, arial2, name_off, code_off2, name_on, code_on2) {
...
export function wepsim_config_button_html_2options(id2, arial2, name_off, val_off, code_off2, name_on, val_on, code_on2) {
    return "<div class='col-12 p-0 btn-group btn-group-toggle d-flex' data-bs-toggle='buttons'>" +
