...
export class ws_editor_cm6 {
    ...
    setTheme(theme) {
        ...
        switch (theme) {
            case "default":
                ...
                break;
            case "blackboard":
                extension = (_a = this.CM6.blackboardTheme) !== null && _a !== void 0 ? _a : [];
                break;
            case "eclipse":
                extension = (_b = this.CM6.eclipseTheme) !== null && _b !== void 0 ? _b : [];
                break;
        }
        this.view.dispatch({
    ...
    setKeyMap(name) {
        ...
        switch (name) {
            case "default":
                ...
                break;
            case "vim":
                extension = this.CM6.vim();
                break;
            case "emacs":
                extension = (_a = this.CM6.emacsKeymap) !== null && _a !== void 0 ? _a : [];
                break;
        }
        this.view.dispatch({
    ...
    setReadOnly(is_readonly) {
        this.view.dispatch({
            effects: this.readonly_compartment.reconfigure(this.CM6.EditorState.readOnly.of(Boolean(is_readonly)))
        });
    }
...
export function showError(Msg, editor) {
    ...
    wepsim_notify_error('<strong>ERROR</strong>', '<div class="container-fluid p-1 mb-1 mr-1 overflow-auto" ' +
