...
import { get_value, vue_observable, vue_applyBinding } from "../sim_core/sim_core_values.js";
/*
...
export class ws_mem_config extends ws_uielto {
    ...
    render_populate() {
        ...
        if (this.layout == "card")
            ...
            o1 += this.render_populate_as_table(input_div);
        $(div_hash).html(o1);
        // vue binding
        ...
        vue_applyBinding(curr_mp_read_wc.value, '#mp_wc_read_' + input_div, function (value) { return value; });
        ...
        vue_applyBinding(curr_mp_write_wc.value, '#mp_wc_write_' + input_div, function (value) { return value; });
    }
