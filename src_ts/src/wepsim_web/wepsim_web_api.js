...
import { get_cfg, set_cfg, save_cfg, update_cfg } from "../sim_core/sim_cfg.js";
import { simcore_ga } from "../sim_core/sim_core_ga.js";
import { simcore_record_append_new, simcore_record_start, simcore_record_stop, simcore_record_reset, simcore_record_play, simcore_record_playInterval, simcore_record_isRecording, simcore_record_setTimeBeforeNow, simcore_record_pause } from "../sim_core/sim_core_record.js";
...
import { sim_change_workspace, set_ab_size } from "./wepsim_web_simulator.js";
import { wepsim_svg_start_drawing, wepsim_svg_stop_drawing, wepsim_svg_is_drawing } from "./wepsim_uielto_cpusvg.js";
...
import { webui_toolbar_updateMode, webui_toolbar_updateAction } from "./wepsim_uielto_toolbar.js";
...
export function wsweb_change_workspace_simulator() {
    ...
    // add if recording
    simcore_record_append_new('Change to workspace simulator', 'ws.wsweb_change_workspace_simulator();\n');
    // return ok
    return true;
}
export function wsweb_change_workspace_microcode() {
    ...
    // add if recording
    simcore_record_append_new('Change to workspace microcode', 'ws.wsweb_change_workspace_microcode();\n');
    // return ok
    return true;
}
export function wsweb_change_workspace_assembly() {
    ...
    // add if recording
    simcore_record_append_new('Change to workspace assembly', 'ws.wsweb_change_workspace_assembly();\n');
    // return ok
    return true;
}
export function wsweb_change_show_processor() {
    ...
    cpucu_show_graph();
    // add if recording
    simcore_record_append_new('Show processor details', 'ws.wsweb_change_show_processor();\n');
    // return ok
    return true;
}
export function wsweb_change_show_asmdbg() {
    ...
    // add if recording
    simcore_record_append_new('Show assembly debugger', 'ws.wsweb_change_show_asmdbg();\n');
    // return ok
    return true;
}
...
export function wsweb_execution_reset() {
    ...
    // add if recording
    simcore_record_append_new('Reset', 'ws.wsweb_execution_reset();\n');
    // return ok
    return true;
}
export function wsweb_execution_microinstruction() {
    ...
    // add if recording
    simcore_record_append_new('Execute microinstruction', 'ws.wsweb_execution_microinstruction();\n');
    // return ok
    return true;
}
export function wsweb_execution_previous_microinstruction() {
    ...
    // add if recording
    simcore_record_append_new('Execute previous instruction', 'ws.wsweb_execution_previous_microinstruction();\n');
    return true;
}
export function wsweb_execution_instruction() {
    ...
    // add if recording
    simcore_record_append_new('Execute instruction', 'ws.wsweb_execution_instruction();\n');
    // return ok
    return true;
}
export function wsweb_execution_run() {
    ...
    // add if recording
    simcore_record_append_new('Run', 'ws.wsweb_execution_run();\n');
    // intercept events...
    $("#current_state2").one("hidden.bs.modal", function () {
        simcore_record_append_new('Close execution summary', 'ws.wsweb_dialogbox_close_all();\n');
    });
    // return ok
    return true;
}
...
export function wsweb_dialog_open(dialog_id) {
    ...
    // intercept events...
    d1.one("hidden.bs.modal", function () {
        ws.wsweb_dialog_close(dialog_id);
    });
    // add if recording
    simcore_record_append_new('Open dialogbox ' + dialog_id, 'ws.wsweb_dialog_open("' + dialog_id + '");\n');
    // stats about ui
...
export function wsweb_dialog_close(dialog_id) {
    ...
    // add if recording
    simcore_record_append_new('Close dialogbox ' + dialog_id, 'ws.wsweb_dialog_close("' + dialog_id + '");\n');
    // return dialog
    return d1;
}
export function wsweb_dialogbox_close_all() {
    ...
    // add if recording
    simcore_record_append_new('Close all dialogboxes', 'ws.wsweb_dialogbox_close_all();\n');
    // return ok
    return true;
}
...
export function wsweb_dialogbox_open_updatesignal(key, event_type) {
    ...
    // add if recording
    simcore_record_append_new('Open update signal dialogbox for ' + key, 'ws.wepsim_update_signal_dialog(\'' + key + '\');\n');
    wepsim_update_signal_dialog(key);
    // show_states();
    // intercept events...
    $("#dlg_updatesignal").one("hidden.bs.modal", function () {
        simcore_record_append_new('Close update signal dialog', 'ws.wsweb_dialogbox_close_updatesignal();\n');
    });
    // return ok
    return true;
}
export function wsweb_dialogbox_close_updatesignal() {
    ...
    // add if recording
    simcore_record_append_new('Close update signal dialogbox', 'ws.wsweb_dialogbox_close_updatesignal();\n');
    // return ok
    return true;
}
...
export function wsweb_set_details_select(opt) {
    ...
    // add if recording
    simcore_record_append_new('Change select details to ' + opt, 'ws.wsweb_set_details_select(' + opt + ');\n');
    // return ok
    return true;
}
...
export function wsweb_set_details(opt) {
    ...
    // add if recording
    simcore_record_append_new('Set details to ' + opt, 'ws.wsweb_set_details(\'' + opt + '\');\n');
    // return ok
    return true;
}
export function wsweb_select_refresh() {
    ...
    $(".tooltip").hide();
    // add if recording
    simcore_record_append_new('Refresh in selection', 'ws.wsweb_select_refresh();\n');
    // return ok
    return true;
}
...
export function wsweb_select_main(opt) {
    ...
    i18n_update_tags('gui', ws_idiom);
    // add if recording
    simcore_record_append_new('Set main work mode to ' + opt, 'ws.wsweb_select_main("' + opt + '");\n');
    // return ok
    return true;
}
...
export function wsweb_set_cpucu_size(new_value) {
    ...
    save_cfg();
    // add if recording
    simcore_record_append_new('Set cpu-cu size to ' + new_value, 'ws.wsweb_set_cpucu_size(' + new_value + ');\n');
    // return ok
    return true;
}
export function wsweb_set_c1c2_size(new_value) {
    ...
    save_cfg();
    // add if recording
    simcore_record_append_new('Set c1-c2 size to ' + new_value, 'ws.wsweb_set_c1c2_size(' + new_value + ');\n');
    // return ok
    return true;
}
...
export function wsweb_assembly_compile() {
    ...
    // add if recording
    simcore_record_append_new('Compile assembly', 'ws.wsweb_assembly_compile();\n');
    // return ok
    return true;
}
export function wsweb_firmware_compile() {
    ...
    $('#asm_debugger').html(o);
    // add if recording
    simcore_record_append_new('Compile firmware', 'ws.wsweb_firmware_compile();\n');
    // return ok
    return true;
}
...
export function wsweb_save_controlmemory_to_file(firm_version) {
    ...
    // add if recording
    simcore_record_append_new('Save control memory to file', 'ws.wsweb_save_controlmemory_to_file(firm_version);\n');
    // return ok
    return true;
}
...
export function wsweb_quickmenu_show() {
    ...
    // add if recording
    simcore_record_append_new('Open the "quick menu"', 'ws.wsweb_quickmenu_show();\n');
    // return ok
    return true;
}
export function wsweb_quickmenu_close() {
    ...
    // add if recording
    simcore_record_append_new('Close the "quick menu"', 'ws.wsweb_quickmenu_close();\n');
    // return ok
    return true;
}
export function wsweb_quickmenu_toggle() {
    ...
    // add if recording
    simcore_record_append_new('Toggle the "quick menu"', 'ws.wsweb_quickmenu_toggle();\n');
    // return ok
    return true;
}
// quick slider(s)
export function wsweb_quickslider_show() {
    ...
    // add if recording
    simcore_record_append_new('Open the "quick slider"', 'ws.wsweb_quickslider_show();\n');
    // return ok
    return true;
}
export function wsweb_quickslider_close() {
    ...
    // add if recording
    simcore_record_append_new('Close the "quick slider"', 'ws.wsweb_quickslider_close();\n');
    // return ok
    return true;
}
export function wsweb_quickslider_toggle() {
    ...
    // add if recording
    simcore_record_append_new('Toggle the "quick slider"', 'ws.wsweb_quickslider_toggle();\n');
    // return ok
    return true;
}
// quick cpucu
export function wsweb_quickcpuview_show() {
    ...
    // add if recording
    simcore_record_append_new('Open the "quick cpuview"', 'ws.wsweb_quickcpuview_show();\n');
    // return ok
    return true;
}
export function wsweb_quickcpuview_close() {
    ...
    // add if recording
    simcore_record_append_new('Close the "quick cpuview"', 'ws.wsweb_quickcpuview_close();\n');
    // return ok
    return true;
}
export function wsweb_quickcpuview_toggle() {
    ...
    // add if recording
    simcore_record_append_new('Toggle the "quick cpuview"', 'ws.wsweb_quickcpuview_toggle();\n');
    // return ok
    return true;
}
export function wsweb_cpuview_as_graph() {
    ...
    show_cpuview_view();
    // add if recording
    simcore_record_append_new('Toggle to "view as graphic"', 'ws.wsweb_cpuview_as_graph();\n');
    // return ok
    return true;
}
export function wsweb_cpuview_as_text() {
    ...
    show_cpuview_view();
    // add if recording
    simcore_record_append_new('Toggle to "view as text"', 'ws.wsweb_cpuview_as_text();\n');
    // return ok
    return true;
}
// quick rfcfg
export function wsweb_quickrf_show() {
    ...
    // add if recording
    simcore_record_append_new('Open the "quick rfcfg"', 'ws.wsweb_quickrf_show();\n');
    // return ok
    return true;
}
export function wsweb_quickrf_close() {
    ...
    // add if recording
    simcore_record_append_new('Close the "quick rfcfg"', 'ws.wsweb_quickrf_close();\n');
    // return ok
    return true;
}
export function wsweb_quickrf_toggle() {
    ...
    // add if recording
    simcore_record_append_new('Toggle the "quick rfcfg"', 'ws.wsweb_quickrf_toggle();\n');
    // return ok
    return true;
}
// recordbar
export function wsweb_recordbar_show() {
    ...
    // add if recording
    simcore_record_append_new('Open the "record toolbar"', 'ws.wsweb_recordbar_show();\n');
    // return ok
    return true;
}
export function wsweb_recordbar_toggle() {
    ...
    // add if recording
    simcore_record_append_new('Toggle the "record toolbar"', 'ws.wsweb_recordbar_toggle();\n');
    // return ok
    return true;
}
export function wsweb_recordbar_close() {
    $('#record_div').hide();
    // add if recording
    simcore_record_append_new('Close the "record toolbar"', 'ws.wsweb_recordbar_close();\n');
    // return ok
    return true;
}
//
    ...
    bbbt.end = {
        ...
        callback: function () {
            ...
            if (isNaN(w_duration))
                ...
                w_duration = 1000 * w_duration;
            // add if recording
            simcore_record_setTimeBeforeNow(500);
            simcore_record_append_new('Show message with title "' + s_title + '" and body "' + s_message + '".', 'ws.wsweb_notifyuser_show("' + w_title + '", "' + c_message + '", "' + w_duration + '");\n');
            simcore_record_setTimeBeforeNow(w_duration);
            simcore_record_append_new('Close message with title "' + s_title + '".', 'ws.wsweb_notifyuser_hide();\n');
...
export function wsweb_scroll_record(container_id) {
    ...
    var add_scroll_to = function () {
        ...
        simcore_record_append_new('Scroll content', 'ws.wsweb_scroll_to("' + container_id + '", ' + div_pos + ');\n');
    };
