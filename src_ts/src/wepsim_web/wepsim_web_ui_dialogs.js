...
export var wsweb_dialogs = {
    load_save_assembly: {
        id: "lssvasm",
        title: function () {
            return wepsim_config_dialog_title("Load/Save Assembly", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    load_save_firmware: {
        id: "lssvfir",
        title: function () {
            return ws.wepsim_config_dialog_title("Load/Save Firmware", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    load_save_firmware_link: {
        id: "lssvfir",
        title: function () {
            return wepsim_config_dialog_title("Load/Save Firmware", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    flash_assembly: {
        id: "flashasm",
        title: function () {
            return wepsim_config_dialog_title("Flash Assembly", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    flash_fpga: {
        id: "flashfpga",
        title: function () {
            return wepsim_config_dialog_title("Flash FPGA", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    binary_asm: {
        id: "bin_asm",
        title: function () {
            return ws.wepsim_config_dialog_title("Binary", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    about: {
        id: "about1",
        title: function () {
            return ws.wepsim_config_dialog_title("About WepSIM", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
    ...
    notifications: {
        id: "notifications3",
        title: function () {
            return ws.wepsim_config_dialog_title("Notifications", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    examples: {
        id: "example1",
        title: function () {
            return ws.wepsim_config_dialog_title("Examples", "primary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    config: {
        id: "config2",
        title: function () {
            return ws.wepsim_config_dialog_title("Configuration", "primary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    help: {
        id: "help1",
        title: function () {
            return ws.wepsim_config_dialog_title("Help", "success", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    state: {
        id: "current_state1",
        title: function () {
            return ws.wepsim_config_dialog_title("State", "dark", "var ws_idiom = ws.get_cfg('ws_idiom');" +
    ...
    current_checkpoint: {
        ...
        title: function () {
            return ws.wepsim_config_dialog_title("Checkpoint", "secondary", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialog', ws_idiom);");
        },
        body: function () {
    ...
    reload: {
        id: "reload1",
        title: function () {
            return ws.wepsim_config_dialog_title("Reload", "danger", "var ws_idiom = ws.get_cfg('ws_idiom');" +
                "ws.i18n_update_tags('dialogs', ws_idiom);");
        },
        body: function () {
