...
import { firedep_to_fireorder, jit_fire_dep } from "./sim_hw_signal.js";
import { check_behavior, compile_behaviors, compile_verbals } from "./sim_hw_behavior.js";
...
export function simhw_sim_state_getref(id) {
    ...
    if (parts.length > 2)
        ...
        s_ref = simhw_sim_states().BR[parts[1]];
    return s_ref;
}
// syntax_behaviours
