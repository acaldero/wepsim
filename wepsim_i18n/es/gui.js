...
export function i18n_es_register_gui(i18n)
{
    ...
    i18n.eltos.gui.es = {
        ...
        'simulator intro 1': "Puede seleccionar el hardware que se utilizar&aacute;. El predeterminado es el hardware EP (Elemental Processor). <br> Puede usar <span class='text-primary bg-body-tertiary' onclick=\"setTimeout(function(){$('#dd1').dropdown('toggle');},50);\">el selector de modo</span> para cambiar el hardware utilizado",

        'simulator intro 2': "A continuaci&oacute;n necesita cargar el microc&oacute;digo (define el conjunto de instrucciones) y el c&oacute;digo de ensamblador. <br> Puede usar <span class='text-primary bg-body-tertiary' onclick='wsweb_dialog_open(\"examples\");'>un ejemplo</span>, <span class='text-primary bg-body-tertiary' onclick='wsweb_select_action(\"checkpoint\");;'>cargarlo desde un archivo</span>, o puede editar <span class='text-primary bg-body-tertiary' onclick='wsweb_change_workspace_microcode();'>un nuevo microc&oacute;digo</span> y <span class='text-primary bg-body-tertiary' onclick='wsweb_change_workspace_assembly();'>un nuevo c&oacute;digo de ensamblador</span>.",
